...
class EDTestCasePluginExecuteControlInterfacev1_3_DLS_THAU_Strategy2(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputInterface_DLS_THAU_Strategy2.xml"))
