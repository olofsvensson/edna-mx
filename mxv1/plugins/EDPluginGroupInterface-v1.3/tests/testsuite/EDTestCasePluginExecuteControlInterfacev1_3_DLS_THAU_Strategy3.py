...
class EDTestCasePluginExecuteControlInterfacev1_3_DLS_THAU_Strategy3(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputInterface_DLS_THAU_Strategy3.xml"))


    def preProcess(self):
        EDTestCasePluginExecute.preProcess(self)
        self.loadTestImage([ "THAU_1_0001.cbf", "THAU_1_0002.cbf", "THAU_1_0003.cbf"])
