...
class EDTestCasePluginExecuteControlInterfacev1_3_NtermA46(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputInterface_NtermA46.xml"))


    def preProcess(self):
        EDTestCasePluginExecute.preProcess(self)
        self.loadTestImage([ "ref-11121-NtermA46_2_4_0001.cbf", "ref-11121-NtermA46_2_4_0002.cbf", 
                            "ref-11121-NtermA46_2_4_0003.cbf", "ref-11121-NtermA46_2_4_0004.cbf" ])
