...
#
#    File: "$Id: EDTestCasePluginExecuteControlInterfacev1_3.py 1606 2010-06-04 09:59:48Z svensson $"
#
...
class EDTestCasePluginExecuteControlInterfacev1_3_eiger4m(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputInterface_eiger4m.xml"))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlInterfacev1_3 = EDTestCasePluginExecuteControlInterfacev1_3("EDTestCasePluginExecuteControlInterfacev1_3")
    edTestCasePluginExecuteControlInterfacev1_3.execute()
