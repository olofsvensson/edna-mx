...
#
# Generated Mon Mar 25 02:28::06 2024 by EDGenerateDS.
#
...
class XSDataInputControlXia2DIALS(XSDataInput):
    def __init__(self, configuration=None, no_cores=None, exclude_range=None, reprocess=None, endFrame=None, startFrame=None, unitCell=None, spaceGroup=None, doAnomAndNonanom=None, doAnom=None, processDirectory=None, icatProcessDataDir=None, dataCollectionId=None):
        ...
        if no_cores is None:
            ...
            strMessage = "ERROR! XSDataInputControlXia2DIALS constructor argument 'no_cores' is not XSDataInteger but %s" % self._no_cores.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setNo_cores(self, no_cores):
        if no_cores is None:
            ...
            strMessage = "ERROR! XSDataInputControlXia2DIALS.setNo_cores argument is not XSDataInteger but %s" % no_cores.__class__.__name__
            raise BaseException(strMessage)
