...
class EDTestCasePluginExecuteControlXia2DIALSv1_0_spaceGroupCell(EDTestCasePluginExecute):

    def __init__(self, _oalStringTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlXia2DIALSv1_0")
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputControlXia2DIALS_spaceGroupCell.xml"))
