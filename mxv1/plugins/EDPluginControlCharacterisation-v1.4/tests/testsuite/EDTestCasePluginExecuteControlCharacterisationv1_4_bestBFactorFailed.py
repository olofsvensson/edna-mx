...
class EDTestCasePluginExecuteControlCharacterisationv1_4_bestBFactorFailed(EDTestCasePluginExecuteControlCharacterisationv1_4):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_4.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_4_bestBFactorFailed")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_4_bestBFactorFailed = EDTestCasePluginExecuteControlCharacterisationv1_4_bestBFactorFailed("EDTestCasePluginExecuteControlCharacterisationv1_4_bestBFactorFailed")
    edTestCasePluginExecuteControlCharacterisationv1_4_bestBFactorFailed.execute()
