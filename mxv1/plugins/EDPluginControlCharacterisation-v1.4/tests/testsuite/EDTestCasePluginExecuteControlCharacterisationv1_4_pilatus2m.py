...
class EDTestCasePluginExecuteControlCharacterisationv1_4_pilatus2m(EDTestCasePluginExecuteControlCharacterisationv1_4):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_4.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_4_pilatus2m")
