...
class EDTestCasePluginExecuteControlCharacterisationv1_4With2Sweep(EDTestCasePluginExecuteControlCharacterisationv1_4):
    """
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_4.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_4With2Sweep")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_4With2Sweep = EDTestCasePluginExecuteControlCharacterisationv1_4With2Sweep("EDTestCasePluginExecuteControlCharacterisationv1_4With2Sweep")
    edTestCasePluginExecuteControlCharacterisationv1_4With2Sweep.execute()
