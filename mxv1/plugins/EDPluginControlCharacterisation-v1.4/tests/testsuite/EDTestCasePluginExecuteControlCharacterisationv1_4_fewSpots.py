...
class EDTestCasePluginExecuteControlCharacterisationv1_4_fewSpots(EDTestCasePluginExecuteControlCharacterisationv1_4):
    """
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_4_fewSpots = EDTestCasePluginExecuteControlCharacterisationv1_4_fewSpots("EDTestCasePluginExecuteControlCharacterisationv1_4_fewSpots")
    edTestCasePluginExecuteControlCharacterisationv1_4_fewSpots.execute()
