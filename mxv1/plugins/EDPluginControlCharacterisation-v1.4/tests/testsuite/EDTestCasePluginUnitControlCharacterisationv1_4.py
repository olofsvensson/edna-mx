...
class EDTestCasePluginUnitControlCharacterisationv1_4(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlCharacterisationv1_4")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlCharacterisationv1_4 = EDTestCasePluginUnitControlCharacterisationv1_4("EDTestCasePluginUnitControlCharacterisationv1_4")
    EDTestCasePluginUnitControlCharacterisationv1_4.execute()
