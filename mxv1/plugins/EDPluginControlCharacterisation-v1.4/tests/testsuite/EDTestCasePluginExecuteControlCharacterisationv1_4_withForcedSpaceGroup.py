...
class EDTestCasePluginExecuteControlCharacterisationv1_4_withForcedSpaceGroup(EDTestCasePluginExecuteControlCharacterisationv1_4):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_4.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_4_withForcedSpaceGroup")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_4_withForcedSpaceGroup = EDTestCasePluginExecuteControlCharacterisationv1_4_withForcedSpaceGroup("EDTestCasePluginExecuteControlCharacterisationv1_4_withForcedSpaceGroup")
    edTestCasePluginExecuteControlCharacterisationv1_4_withForcedSpaceGroup.execute()
