...
class EDTestCasePluginExecuteControlCharacterisationv1_4_indexingError(EDTestCasePluginExecuteControlCharacterisationv1_4):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_4.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_4_indexingError")
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation_indexingError.xml"))
        self.setNoExpectedWarningMessages(5)
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_4_indexingError = EDTestCasePluginExecuteControlCharacterisationv1_4_indexingError("EDTestCasePluginExecuteControlCharacterisationv1_4_indexingError")
    edTestCasePluginExecuteControlCharacterisationv1_4_indexingError.execute()
