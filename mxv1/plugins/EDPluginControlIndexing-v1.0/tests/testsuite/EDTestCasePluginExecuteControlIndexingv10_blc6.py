...
class EDTestCasePluginExecuteControlIndexingv10_blc6(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataIndexingInput_blc6.xml"))
        self.strReferenceDataOutputFile = os.path.join(self.getPluginTestsDataHome(), "XSDataIndexingResult_blc6.xml")
