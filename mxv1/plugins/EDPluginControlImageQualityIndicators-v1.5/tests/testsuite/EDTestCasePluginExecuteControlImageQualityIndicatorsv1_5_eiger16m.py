...
class EDTestCasePluginExecuteControlImageQualityIndicatorsv1_5_eiger16m(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputControlImageQualityIndicators_eiger16m.xml"))
