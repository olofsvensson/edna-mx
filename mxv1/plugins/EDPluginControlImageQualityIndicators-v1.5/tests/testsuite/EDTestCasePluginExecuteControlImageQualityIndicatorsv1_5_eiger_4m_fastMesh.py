...
class EDTestCasePluginExecuteControlImageQualityIndicatorsv1_5_eiger_4m_fastMesh(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputControlImageQualityIndicators_eiger_4m_fastMesh.xml"))
