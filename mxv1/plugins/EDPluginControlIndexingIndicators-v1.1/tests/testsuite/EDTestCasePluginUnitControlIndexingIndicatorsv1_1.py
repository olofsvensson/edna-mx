...
class EDTestCasePluginUnitControlIndexingIndicatorsv1_1(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlIndexingIndicatorsv1_1")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlIndexingIndicatorsv11 = EDTestCasePluginUnitControlIndexingIndicatorsv11("EDTestCasePluginUnitControlIndexingIndicatorsv11")
    EDTestCasePluginUnitControlIndexingIndicatorsv11.execute()
