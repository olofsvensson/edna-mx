...
#
# Generated Mon May 23 01:18::30 2016 by EDGenerateDS.
#
...
class XSDataInputSimpleHTMLPage(XSDataInput):
    ...
    def insertFileGraph(self, index, value):
        ...
        if value is None:
            ...
            strMessage = "ERROR! XSDataInputSimpleHTMLPage.addFileGraph argument is not XSDataFile but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'helicalDistance' attribute
    def getHelicalDistance(self): return self._helicalDistance
    def setHelicalDistance(self, helicalDistance):
        if helicalDistance is None:
            self._helicalDistance = None
        elif helicalDistance.__class__.__name__ == "XSDataDouble":
            self._helicalDistance = helicalDistance
        else:
            strMessage = "ERROR! XSDataInputSimpleHTMLPage.setHelicalDistance argument is not XSDataDouble but %s" % helicalDistance.__class__.__name__
            raise BaseException(strMessage)
