...
class EDTestCasePluginExecuteControlDozorv1_0_100k_images(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputControlDozor_100k_images.xml"))
