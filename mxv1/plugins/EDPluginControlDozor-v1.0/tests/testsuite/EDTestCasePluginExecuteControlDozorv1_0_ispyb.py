...
class EDTestCasePluginExecuteControlDozorv1_0_ispyb(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputControlDozor_ispyb.xml"))
