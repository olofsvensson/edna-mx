...
class EDTestCasePluginExecuteControlDozorv1_0_batchSize_5(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputControlDozor_batchSize_5.xml"))
