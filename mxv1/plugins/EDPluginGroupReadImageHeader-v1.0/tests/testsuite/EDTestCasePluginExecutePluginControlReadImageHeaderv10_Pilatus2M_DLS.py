...
class EDTestCasePluginExecutePluginControlReadImageHeaderv10_Pilatus2M_DLS(EDTestCasePluginExecutePluginControlReadImageHeaderv10):
    ...
    def __init__(self, _strTestName="EDPluginControlReadImageHeaderv10"):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputReadImageHeader_Pilatus2M_DLS_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultReadImageHeader_Pilatus2M_DLS_reference.xml"))
