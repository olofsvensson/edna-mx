...
class EDTestCasePluginExecutePluginControlReadImageHeaderv10_Eiger9M(EDTestCasePluginExecutePluginControlReadImageHeaderv10):
    ...
    def __init__(self, _strTestName="EDPluginControlReadImageHeaderv10"):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputReadImageHeader_Eiger9M_reference.xml"))
