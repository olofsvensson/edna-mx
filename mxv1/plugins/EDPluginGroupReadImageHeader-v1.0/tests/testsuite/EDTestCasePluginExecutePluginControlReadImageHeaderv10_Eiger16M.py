...
class EDTestCasePluginExecutePluginControlReadImageHeaderv10_Eiger16M(EDTestCasePluginExecutePluginControlReadImageHeaderv10):
    ...
    def __init__(self, _strTestName="EDPluginControlReadImageHeaderv10"):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputReadImageHeader_Eiger16M_reference.xml"))


    def preProcess(self):
        EDTestCasePluginExecutePluginControlReadImageHeaderv10.preProcess(self)
        self.loadTestImage([ "eiger16m_1_1000.cbf" ])
