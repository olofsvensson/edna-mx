...
class EDTestCasePluginExecuteControlPyarchThumbnailGeneratorv1_0_eiger_4m(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           ...
                                           "XSDataInputPyarchThumbnailGenerator_eiger_4m.xml"))
    def preProcess(self):
        EDTestCasePluginExecute.preProcess(self)
        self.loadTestImage([ "ref-test_3_2_master.h5", "ref-test_3_2_data_000001.h5" ])
