...
class EDTestCasePluginExecuteExecSimpleHTMLPagev1_0_npos_withQt3Render(EDTestCasePluginExecute):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginExecSimpleHTMLPagev1_0")
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputSimpleHTMLPage_npos.xml"))
