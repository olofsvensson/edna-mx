...
class EDTestCasePluginUnitControlStrategyv1_3(EDTestCasePluginUnit):

    def __init__(self, _pyStrTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlStrategyv1_3", "EDPluginControlStrategy-v1.1", _pyStrTestName)
        self.strDataPath = self.getPluginTestsDataHome()
        self.strObtainedInputFile = "XSDataInputStrategyv1_3.xml"
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitControlStrategyv1_3 = EDTestCasePluginUnitControlStrategyv1_3("EDTestCasePluginUnitControlStrategyv1_3")
    edTestCasePluginUnitControlStrategyv1_3.execute()
