...
class EDTestCasePluginExecuteControlCharacterisationv1_6(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlCharacterisationv1_6")
