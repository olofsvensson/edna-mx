...
class EDTestCasePluginUnitControlCharacterisationv1_6(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlCharacterisationv1_6")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlCharacterisationv1_6 = EDTestCasePluginUnitControlCharacterisationv1_6("EDTestCasePluginUnitControlCharacterisationv1_6")
    EDTestCasePluginUnitControlCharacterisationv1_6.execute()
