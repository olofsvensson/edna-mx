...
cd {path}
/opt/pxsoft/tools/python/v2.6.6_20110210/centos5-x86_64/bin/python {edna_path}/kernel/bin/edna-plugin-launcher.py --inputFile {dm_path} --conf {config_path} --execute EDPluginControlEDNAprocv1_0 --debug
'''
