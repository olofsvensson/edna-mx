...
class EDTestCasePluginControlEDNAprocv1_0_id23eh2_20181023(EDTestCasePluginExecute):
    """
    ...
    def __init__(self, _strTestName=None):
        ...
        self.strTestDir = os.path.join(self.getPluginTestsDataHome(), "id23eh2_20181023")
