...
class EDTestCasePluginExecuteControlInterfacev1_2_eiger16m(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputInterface_eiger16m.xml"))


    def preProcess(self):
        EDTestCasePluginExecute.preProcess(self)
        self.loadTestImage([ "eiger16m_1_1000.cbf", "eiger16m_1_2000.cbf" ])
