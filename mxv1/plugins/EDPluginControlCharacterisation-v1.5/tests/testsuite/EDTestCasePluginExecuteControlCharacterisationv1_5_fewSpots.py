...
class EDTestCasePluginExecuteControlCharacterisationv1_5_fewSpots(EDTestCasePluginExecuteControlCharacterisationv1_5):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_5.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_5_fewSpots")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_5_fewSpots = EDTestCasePluginExecuteControlCharacterisationv1_5_fewSpots("EDTestCasePluginExecuteControlCharacterisationv1_5_fewSpots")
    edTestCasePluginExecuteControlCharacterisationv1_5_fewSpots.execute()
