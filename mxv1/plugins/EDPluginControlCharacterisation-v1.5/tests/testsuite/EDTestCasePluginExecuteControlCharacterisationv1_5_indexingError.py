...
class EDTestCasePluginExecuteControlCharacterisationv1_5_indexingError(EDTestCasePluginExecuteControlCharacterisationv1_5):
    """
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_5_indexingError = EDTestCasePluginExecuteControlCharacterisationv1_5_indexingError("EDTestCasePluginExecuteControlCharacterisationv1_5_indexingError")
    edTestCasePluginExecuteControlCharacterisationv1_5_indexingError.execute()
