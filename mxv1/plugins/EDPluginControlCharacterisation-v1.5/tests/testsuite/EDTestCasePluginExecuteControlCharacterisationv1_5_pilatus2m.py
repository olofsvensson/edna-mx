...
class EDTestCasePluginExecuteControlCharacterisationv1_5_pilatus2m(EDTestCasePluginExecuteControlCharacterisationv1_5):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_5.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_5_pilatus2m")
