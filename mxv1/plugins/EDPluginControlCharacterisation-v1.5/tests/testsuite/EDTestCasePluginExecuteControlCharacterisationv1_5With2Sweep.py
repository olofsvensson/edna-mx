...
class EDTestCasePluginExecuteControlCharacterisationv1_5With2Sweep(EDTestCasePluginExecuteControlCharacterisationv1_5):
    """
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_5.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_5With2Sweep")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_5With2Sweep = EDTestCasePluginExecuteControlCharacterisationv1_5With2Sweep("EDTestCasePluginExecuteControlCharacterisationv1_5With2Sweep")
    edTestCasePluginExecuteControlCharacterisationv1_5With2Sweep.execute()
