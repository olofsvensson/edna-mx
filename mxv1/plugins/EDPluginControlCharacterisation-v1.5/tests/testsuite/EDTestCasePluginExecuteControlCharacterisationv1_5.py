...
class EDTestCasePluginExecuteControlCharacterisationv1_5(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlCharacterisationv1_5")
