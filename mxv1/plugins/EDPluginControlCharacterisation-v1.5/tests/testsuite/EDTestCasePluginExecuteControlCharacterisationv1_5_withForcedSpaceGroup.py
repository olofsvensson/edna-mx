...
class EDTestCasePluginExecuteControlCharacterisationv1_5_withForcedSpaceGroup(EDTestCasePluginExecuteControlCharacterisationv1_5):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_5.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_5_withForcedSpaceGroup")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_5_withForcedSpaceGroup = EDTestCasePluginExecuteControlCharacterisationv1_5_withForcedSpaceGroup("EDTestCasePluginExecuteControlCharacterisationv1_5_withForcedSpaceGroup")
    edTestCasePluginExecuteControlCharacterisationv1_5_withForcedSpaceGroup.execute()
