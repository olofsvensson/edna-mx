...
class EDTestCasePluginExecuteControlCharacterisationv1_5_integrationError(EDTestCasePluginExecuteControlCharacterisationv1_5):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_5.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_5_integrationError")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_5_integrationError = EDTestCasePluginExecuteControlCharacterisationv1_5_integrationError("EDTestCasePluginExecuteControlCharacterisationv1_5_integrationError")
    edTestCasePluginExecuteControlCharacterisationv1_5_integrationError.execute()
