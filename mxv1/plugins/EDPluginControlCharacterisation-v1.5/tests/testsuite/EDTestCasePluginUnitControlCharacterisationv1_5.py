...
class EDTestCasePluginUnitControlCharacterisationv1_5(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlCharacterisationv1_5")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlCharacterisationv1_5 = EDTestCasePluginUnitControlCharacterisationv1_5("EDTestCasePluginUnitControlCharacterisationv1_5")
    EDTestCasePluginUnitControlCharacterisationv1_5.execute()
