...
class EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_4_id23eh2(EDTestCasePluginExecute):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlInterfaceToMXCuBEv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputMXCuBE_id23eh2.xml"))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_4 = EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_4("EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_4")
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_4.execute()
