...
from XSDataMXCuBEv1_4 import XSDataResultCharacterisation


class EDTestCasePluginUnitControlInterfaceToMXCuBEv1_4(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlInterfaceToMXCuBEv1_4")
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitControlInterfaceToMXCuBEv1_4 = EDTestCasePluginUnitControlInterfaceToMXCuBEv1_4("EDTestCasePluginUnitControlInterfaceToMXCuBEv1_4")
    edTestCasePluginUnitControlInterfaceToMXCuBEv1_4.execute()
