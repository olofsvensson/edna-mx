...
class EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_4_eiger2_16m_2(EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_4):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_4.__init__(self, "EDPluginControlInterfaceToMXCuBEv1_4")
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputMXCuBE_eiger2_16m_2.xml"))
