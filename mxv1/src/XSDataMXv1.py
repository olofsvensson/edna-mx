...
#
# Generated Thu Jun 22 02:59::23 2023 by EDGenerateDS.
#
...
- The wavelength (a)
- Transmission in %"""
    def __init__(self, apertureSize=None, wavelength=None, transmission=None, size=None, minExposureTimePerImage=None, flux=None, exposureTime=None):
        XSData.__init__(self, )
        ...
        if apertureSize is None:
            ...
            strMessage = "ERROR! XSDataBeam constructor argument 'apertureSize' is not XSDataLength but %s" % self._apertureSize.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setApertureSize(self, apertureSize):
        if apertureSize is None:
            ...
            strMessage = "ERROR! XSDataBeam.setApertureSize argument is not XSDataLength but %s" % apertureSize.__class__.__name__
            raise BaseException(strMessage)
...
- numberOfPositions: optional input for BEST"""
    def __init__(self, userDefinedRotationStart=None, userDefinedRotationRange=None, strategyType=None, strategyOption=None, rFriedel=None, requiredResolution=None, requiredMultiplicity=None, requiredCompleteness=None, numberOfPositions=None, minTransmission=None, minExposureTimePerImage=None, maxExposureTimePerDataCollection=None, kappaStrategyOption=None, goniostatMinOscillationWidth=None, goniostatMaxOscillationSpeed=None, forcedSpaceGroup=None, estimateRadiationDamage=None, doseLimit=None, detectorDistanceMin=None, detectorDistanceMax=None, complexity=None, anomalousData=None, aimedResolution=None, aimedMultiplicity=None, aimedIOverSigmaAtHighestResolution=None, aimedCompleteness=None):
        ...
        if doseLimit is None:
            ...
            strMessage = "ERROR! XSDataDiffractionPlan constructor argument 'doseLimit' is not XSDataDouble but %s" % self._doseLimit.__class__.__name__
            raise BaseException(strMessage)
        ...
        if rFriedel is None:
            ...
            strMessage = "ERROR! XSDataDiffractionPlan constructor argument 'rFriedel' is not XSDataDouble but %s" % self._rFriedel.__class__.__name__
            raise BaseException(strMessage)
        ...
        if strategyType is None:
            ...
            strMessage = "ERROR! XSDataDiffractionPlan constructor argument 'strategyType' is not XSDataString but %s" % self._strategyType.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setDoseLimit(self, doseLimit):
        if doseLimit is None:
            ...
            strMessage = "ERROR! XSDataDiffractionPlan.setDoseLimit argument is not XSDataDouble but %s" % doseLimit.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setRFriedel(self, rFriedel):
        if rFriedel is None:
            ...
            strMessage = "ERROR! XSDataDiffractionPlan.setRFriedel argument is not XSDataDouble but %s" % rFriedel.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getStrategyType(self): return self._strategyType
    def setStrategyType(self, strategyType):
        if strategyType is None:
            ...
            strMessage = "ERROR! XSDataDiffractionPlan.setStrategyType argument is not XSDataString but %s" % strategyType.__class__.__name__
            raise BaseException(strMessage)
    def delStrategyType(self): self._strategyType = None
    strategyType = property(getStrategyType, setStrategyType, delStrategyType, "Property for strategyType")
...
class XSDataImageQualityIndicators(XSData):
    def __init__(self, totalIntegratedSignal=None, spotTotal=None, signalRangeMin=None, signalRangeMax=None, signalRangeAverage=None, selectedIndexingSolution=None, saturationRangeMin=None, saturationRangeMax=None, saturationRangeAverage=None, pctSaturationTop50Peaks=None, method2Res=None, method1Res=None, maxUnitCell=None, inResolutionOvrlSpots=None, inResTotal=None, image=None, iceRings=None, goodBraggCandidates=None, binPopCutOffMethod2Res=None, dozorVisibleResolution=None, dozorSpotsResolution=None, dozorSpotsIntAver=None, dozorSpotListShape=None, dozorSpotList=None, dozorSpotFile=None, dozor_score=None):
        ...
        if dozor_score is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozor_score' is not XSDataDouble but %s" % self._dozor_score.__class__.__name__
            raise BaseException(strMessage)
        if dozorSpotFile is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozorSpotFile' is not XSDataFile but %s" % self._dozorSpotFile.__class__.__name__
            raise BaseException(strMessage)
        if dozorSpotList is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozorSpotList' is not XSDataString but %s" % self._dozorSpotList.__class__.__name__
            raise BaseException(strMessage)
        if dozorSpotListShape is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozorSpotListShape' is not list but %s" % self._dozorSpotListShape.__class__.__name__
            raise BaseException(strMessage)
        if dozorSpotsIntAver is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozorSpotsIntAver' is not XSDataDouble but %s" % self._dozorSpotsIntAver.__class__.__name__
            raise BaseException(strMessage)
        if dozorSpotsResolution is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozorSpotsResolution' is not XSDataDouble but %s" % self._dozorSpotsResolution.__class__.__name__
            raise BaseException(strMessage)
        if dozorVisibleResolution is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators constructor argument 'dozorVisibleResolution' is not XSDataDouble but %s" % self._dozorVisibleResolution.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setDozor_score(self, dozor_score):
        if dozor_score is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozor_score argument is not XSDataDouble but %s" % dozor_score.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getDozorSpotFile(self): return self._dozorSpotFile
    def setDozorSpotFile(self, dozorSpotFile):
        if dozorSpotFile is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozorSpotFile argument is not XSDataFile but %s" % dozorSpotFile.__class__.__name__
            raise BaseException(strMessage)
    def delDozorSpotFile(self): self._dozorSpotFile = None
    dozorSpotFile = property(getDozorSpotFile, setDozorSpotFile, delDozorSpotFile, "Property for dozorSpotFile")
    # Methods and properties for the 'dozorSpotList' attribute
    def getDozorSpotList(self): return self._dozorSpotList
    def setDozorSpotList(self, dozorSpotList):
        if dozorSpotList is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozorSpotList argument is not XSDataString but %s" % dozorSpotList.__class__.__name__
            raise BaseException(strMessage)
    def delDozorSpotList(self): self._dozorSpotList = None
    dozorSpotList = property(getDozorSpotList, setDozorSpotList, delDozorSpotList, "Property for dozorSpotList")
    # Methods and properties for the 'dozorSpotListShape' attribute
    def getDozorSpotListShape(self): return self._dozorSpotListShape
    def setDozorSpotListShape(self, dozorSpotListShape):
        if dozorSpotListShape is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozorSpotListShape argument is not list but %s" % dozorSpotListShape.__class__.__name__
            raise BaseException(strMessage)
    def delDozorSpotListShape(self): self._dozorSpotListShape = None
    dozorSpotListShape = property(getDozorSpotListShape, setDozorSpotListShape, delDozorSpotListShape, "Property for dozorSpotListShape")
    def addDozorSpotListShape(self, value):
        if value is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.addDozorSpotListShape argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getDozorSpotsIntAver(self): return self._dozorSpotsIntAver
    def setDozorSpotsIntAver(self, dozorSpotsIntAver):
        if dozorSpotsIntAver is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozorSpotsIntAver argument is not XSDataDouble but %s" % dozorSpotsIntAver.__class__.__name__
            raise BaseException(strMessage)
    def delDozorSpotsIntAver(self): self._dozorSpotsIntAver = None
    dozorSpotsIntAver = property(getDozorSpotsIntAver, setDozorSpotsIntAver, delDozorSpotsIntAver, "Property for dozorSpotsIntAver")
    # Methods and properties for the 'dozorSpotsResolution' attribute
    def getDozorSpotsResolution(self): return self._dozorSpotsResolution
    def setDozorSpotsResolution(self, dozorSpotsResolution):
        if dozorSpotsResolution is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozorSpotsResolution argument is not XSDataDouble but %s" % dozorSpotsResolution.__class__.__name__
            raise BaseException(strMessage)
    def delDozorSpotsResolution(self): self._dozorSpotsResolution = None
    dozorSpotsResolution = property(getDozorSpotsResolution, setDozorSpotsResolution, delDozorSpotsResolution, "Property for dozorSpotsResolution")
    # Methods and properties for the 'dozorVisibleResolution' attribute
    def getDozorVisibleResolution(self): return self._dozorVisibleResolution
    def setDozorVisibleResolution(self, dozorVisibleResolution):
        if dozorVisibleResolution is None:
            ...
            strMessage = "ERROR! XSDataImageQualityIndicators.setDozorVisibleResolution argument is not XSDataDouble but %s" % dozorVisibleResolution.__class__.__name__
            raise BaseException(strMessage)
    def delDozorVisibleResolution(self): self._dozorVisibleResolution = None
    dozorVisibleResolution = property(getDozorVisibleResolution, setDozorVisibleResolution, delDozorVisibleResolution, "Property for dozorVisibleResolution")
    ...
    def exportChildren(self, outfile, level, name_='XSDataImageQualityIndicators'):
        ...
        if self._dozorSpotsResolution is not None:
            self.dozorSpotsResolution.export(outfile, level, name_='dozorSpotsResolution')
        if self._dozorVisibleResolution is not None:
            self.dozorVisibleResolution.export(outfile, level, name_='dozorVisibleResolution')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'dozorSpotFile':
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setDozorSpotFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dozorSpotList':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setDozorSpotList(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dozorSpotListShape':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.dozorSpotListShape.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dozorSpotsIntAver':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setDozorSpotsIntAver(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dozorSpotsResolution':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setDozorSpotsResolution(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dozorVisibleResolution':
            obj_ = XSDataDouble()
            obj_.build(child_)
...
class XSDataInputControlKappa(XSData):
    def __init__(self, selectedSolution=None, dataCollection=None):
        ...
        if dataCollection is None:
            ...
            strMessage = "ERROR! XSDataInputControlKappa constructor argument 'dataCollection' is not XSDataCollection but %s" % self._dataCollection.__class__.__name__
            raise BaseException(strMessage)
        if selectedSolution is None:
            ...
            strMessage = "ERROR! XSDataInputControlKappa constructor argument 'selectedSolution' is not XSDataIndexingSolutionSelected but %s" % self._selectedSolution.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setDataCollection(self, dataCollection):
        if dataCollection is None:
            ...
            strMessage = "ERROR! XSDataInputControlKappa.setDataCollection argument is not XSDataCollection but %s" % dataCollection.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setSelectedSolution(self, selectedSolution):
        if selectedSolution is None:
            ...
            strMessage = "ERROR! XSDataInputControlKappa.setSelectedSolution argument is not XSDataIndexingSolutionSelected but %s" % selectedSolution.__class__.__name__
            raise BaseException(strMessage)
    ...
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputControlKappa is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
...
- the susceptibility of the sample to radiation damage."""
    def __init__(self, susceptibility=None, omegaMin=None, size=None, shape=None, radiationDamageModelGamma=None, radiationDamageModelBeta=None, absorbedDoseRate=None):
        XSData.__init__(self, )
        ...
        if omegaMin is None:
            ...
            strMessage = "ERROR! XSDataSample constructor argument 'omegaMin' is not XSDataAngle but %s" % self._omegaMin.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getOmegaMin(self): return self._omegaMin
    def setOmegaMin(self, omegaMin):
        if omegaMin is None:
            ...
            strMessage = "ERROR! XSDataSample.setOmegaMin argument is not XSDataAngle but %s" % omegaMin.__class__.__name__
            raise BaseException(strMessage)
    def delOmegaMin(self): self._omegaMin = None
...
- the rotation end angle"""
    def __init__(self, phi=None, kappa=None, samplePosition=None, rotationAxisStart=None, rotationAxisEnd=None, rotationAxis=None, overlap=None, oscillationWidth=None, minOscillationWidth=None, maxOscillationSpeed=None):
        XSData.__init__(self, )
        ...
        if kappa is None:
            ...
            strMessage = "ERROR! XSDataGoniostat constructor argument 'kappa' is not XSDataAngle but %s" % self._kappa.__class__.__name__
            raise BaseException(strMessage)
        if phi is None:
            self._phi = None
            ...
            strMessage = "ERROR! XSDataGoniostat constructor argument 'phi' is not XSDataAngle but %s" % self._phi.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setKappa(self, kappa):
        if kappa is None:
            ...
            strMessage = "ERROR! XSDataGoniostat.setKappa argument is not XSDataAngle but %s" % kappa.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setPhi(self, phi):
        if phi is None:
            ...
            strMessage = "ERROR! XSDataGoniostat.setPhi argument is not XSDataAngle but %s" % phi.__class__.__name__
            raise BaseException(strMessage)
...
class XSDataKappaSolution(XSData):
    def __init__(self, settings=None, phi=None, kappa=None):
        ...
        if kappa is None:
            ...
            strMessage = "ERROR! XSDataKappaSolution constructor argument 'kappa' is not XSDataDouble but %s" % self._kappa.__class__.__name__
            raise BaseException(strMessage)
        if phi is None:
            self._phi = None
            ...
            strMessage = "ERROR! XSDataKappaSolution constructor argument 'phi' is not XSDataDouble but %s" % self._phi.__class__.__name__
            raise BaseException(strMessage)
        if settings is None:
            self._settings = None
            ...
            strMessage = "ERROR! XSDataKappaSolution constructor argument 'settings' is not XSDataString but %s" % self._settings.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'kappa' attribute
    def getKappa(self): return self._kappa
    def setKappa(self, kappa):
        if kappa is None:
            ...
            strMessage = "ERROR! XSDataKappaSolution.setKappa argument is not XSDataDouble but %s" % kappa.__class__.__name__
            raise BaseException(strMessage)
    def delKappa(self): self._kappa = None
    kappa = property(getKappa, setKappa, delKappa, "Property for kappa")
    # Methods and properties for the 'phi' attribute
    ...
    def setPhi(self, phi):
        if phi is None:
            ...
            strMessage = "ERROR! XSDataKappaSolution.setPhi argument is not XSDataDouble but %s" % phi.__class__.__name__
            raise BaseException(strMessage)
    def delPhi(self): self._phi = None
    phi = property(getPhi, setPhi, delPhi, "Property for phi")
    ...
    def setSettings(self, settings):
        if settings is None:
            ...
            strMessage = "ERROR! XSDataKappaSolution.setSettings argument is not XSDataString but %s" % settings.__class__.__name__
            raise BaseException(strMessage)
    ...
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataKappaSolution is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
...
class XSDataInputCharacterisation(XSDataInput):
    def __init__(self, configuration=None, currentResolution=None, token=None, dataCollection=None):
        XSDataInput.__init__(self, configuration)
        if dataCollection is None:
            self._dataCollection = None
        elif dataCollection.__class__.__name__ == "XSDataCollection":
        ...
        if token is None:
            ...
            strMessage = "ERROR! XSDataInputCharacterisation constructor argument 'token' is not XSDataString but %s" % self._token.__class__.__name__
            raise BaseException(strMessage)
        if currentResolution is None:
            ...
            strMessage = "ERROR! XSDataInputCharacterisation constructor argument 'currentResolution' is not XSDataDouble but %s" % self._currentResolution.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollection' attribute
    def getDataCollection(self): return self._dataCollection
    def setDataCollection(self, dataCollection):
    ...
    def setToken(self, token):
        if token is None:
            ...
            strMessage = "ERROR! XSDataInputCharacterisation.setToken argument is not XSDataString but %s" % token.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setCurrentResolution(self, currentResolution):
        if currentResolution is None:
            ...
            strMessage = "ERROR! XSDataInputCharacterisation.setCurrentResolution argument is not XSDataDouble but %s" % currentResolution.__class__.__name__
            raise BaseException(strMessage)
...
class XSDataInputControlISPyB(XSDataInput):
    def __init__(self, configuration=None, phi=None, kappa=None, dataCollectionGroupId=None, characterisationResult=None):
        XSDataInput.__init__(self, configuration)
        ...
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataInputControlISPyB constructor argument 'dataCollectionGroupId' is not XSDataInteger but %s" % self._dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
        if kappa is None:
            self._kappa = None
        elif kappa.__class__.__name__ == "XSDataAngle":
    ...
    def setDataCollectionGroupId(self, dataCollectionGroupId):
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataInputControlISPyB.setDataCollectionGroupId argument is not XSDataInteger but %s" % dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
...
class XSDataInputControlImageQualityIndicators(XSDataInput):
    def __init__(self, configuration=None, endNo=None, startNo=None, template=None, directory=None, wedgeNumber=None, fastMesh=None, batchSize=None, image=None, doUploadToIspyb=None, doIndexing=None, doDistlSignalStrength=None):
        XSDataInput.__init__(self, configuration)
        if doDistlSignalStrength is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'doDistlSignalStrength' is not XSDataBoolean but %s" % self._doDistlSignalStrength.__class__.__name__
            raise BaseException(strMessage)
        ...
        if batchSize is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'batchSize' is not XSDataInteger but %s" % self._batchSize.__class__.__name__
            raise BaseException(strMessage)
        if fastMesh is None:
            self._fastMesh = None
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'fastMesh' is not XSDataBoolean but %s" % self._fastMesh.__class__.__name__
            raise BaseException(strMessage)
        if wedgeNumber is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'wedgeNumber' is not XSDataInteger but %s" % self._wedgeNumber.__class__.__name__
            raise BaseException(strMessage)
        if directory is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'directory' is not XSDataFile but %s" % self._directory.__class__.__name__
            raise BaseException(strMessage)
        if template is None:
            self._template = None
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'template' is not XSDataString but %s" % self._template.__class__.__name__
            raise BaseException(strMessage)
        if startNo is None:
            self._startNo = None
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'startNo' is not XSDataInteger but %s" % self._startNo.__class__.__name__
            raise BaseException(strMessage)
        if endNo is None:
            self._endNo = None
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators constructor argument 'endNo' is not XSDataInteger but %s" % self._endNo.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'doDistlSignalStrength' attribute
    def getDoDistlSignalStrength(self): return self._doDistlSignalStrength
    def setDoDistlSignalStrength(self, doDistlSignalStrength):
        if doDistlSignalStrength is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setDoDistlSignalStrength argument is not XSDataBoolean but %s" % doDistlSignalStrength.__class__.__name__
            raise BaseException(strMessage)
    def delDoDistlSignalStrength(self): self._doDistlSignalStrength = None
    doDistlSignalStrength = property(getDoDistlSignalStrength, setDoDistlSignalStrength, delDoDistlSignalStrength, "Property for doDistlSignalStrength")
    ...
    def setBatchSize(self, batchSize):
        if batchSize is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setBatchSize argument is not XSDataInteger but %s" % batchSize.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getFastMesh(self): return self._fastMesh
    def setFastMesh(self, fastMesh):
        if fastMesh is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setFastMesh argument is not XSDataBoolean but %s" % fastMesh.__class__.__name__
            raise BaseException(strMessage)
    def delFastMesh(self): self._fastMesh = None
    ...
    def setWedgeNumber(self, wedgeNumber):
        if wedgeNumber is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setWedgeNumber argument is not XSDataInteger but %s" % wedgeNumber.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setDirectory(self, directory):
        if directory is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setDirectory argument is not XSDataFile but %s" % directory.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setTemplate(self, template):
        if template is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setTemplate argument is not XSDataString but %s" % template.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setStartNo(self, startNo):
        if startNo is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setStartNo argument is not XSDataInteger but %s" % startNo.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setEndNo(self, endNo):
        if endNo is None:
            ...
            strMessage = "ERROR! XSDataInputControlImageQualityIndicators.setEndNo argument is not XSDataInteger but %s" % endNo.__class__.__name__
            raise BaseException(strMessage)
    ...
    def exportChildren(self, outfile, level, name_='XSDataInputControlImageQualityIndicators'):
        ...
        if self._doDistlSignalStrength is not None:
            self.doDistlSignalStrength.export(outfile, level, name_='doDistlSignalStrength')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'doDistlSignalStrength':
            obj_ = XSDataBoolean()
            obj_.build(child_)
...
class XSDataResultCharacterisation(XSDataResult):
    def __init__(self, status=None, kappaReorientation=None, xdsBackgroundImage=None, strategyResult=None, statusMessage=None, shortSummary=None, integrationResult=None, indexingResult=None, imageQualityIndicators=None, executiveSummary=None, thumbnailImage=None, jpegImage=None, dataCollection=None):
        XSDataResult.__init__(self, status)
        if dataCollection is None:
            self._dataCollection = None
        elif dataCollection.__class__.__name__ == "XSDataCollection":
        ...
        if jpegImage is None:
            ...
            strMessage = "ERROR! XSDataResultCharacterisation constructor argument 'jpegImage' is not list but %s" % self._jpegImage.__class__.__name__
            raise BaseException(strMessage)
        if thumbnailImage is None:
            ...
            strMessage = "ERROR! XSDataResultCharacterisation constructor argument 'thumbnailImage' is not list but %s" % self._thumbnailImage.__class__.__name__
            raise BaseException(strMessage)
        ...
        if kappaReorientation is None:
            ...
            strMessage = "ERROR! XSDataResultCharacterisation constructor argument 'kappaReorientation' is not XSDataResultControlKappa but %s" % self._kappaReorientation.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollection' attribute
    def getDataCollection(self): return self._dataCollection
    def setDataCollection(self, dataCollection):
    ...
    def getJpegImage(self): return self._jpegImage
    def setJpegImage(self, jpegImage):
        if jpegImage is None:
            ...
            strMessage = "ERROR! XSDataResultCharacterisation.setJpegImage argument is not list but %s" % jpegImage.__class__.__name__
            raise BaseException(strMessage)
    def delJpegImage(self): self._jpegImage = None
    jpegImage = property(getJpegImage, setJpegImage, delJpegImage, "Property for jpegImage")
    def addJpegImage(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultCharacterisation.addJpegImage argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataImage":
            self._jpegImage.append(value)
        else:
            strMessage = "ERROR! XSDataResultCharacterisation.addJpegImage argument is not XSDataImage but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getThumbnailImage(self): return self._thumbnailImage
    def setThumbnailImage(self, thumbnailImage):
        if thumbnailImage is None:
            ...
            strMessage = "ERROR! XSDataResultCharacterisation.setThumbnailImage argument is not list but %s" % thumbnailImage.__class__.__name__
            raise BaseException(strMessage)
    def delThumbnailImage(self): self._thumbnailImage = None
    thumbnailImage = property(getThumbnailImage, setThumbnailImage, delThumbnailImage, "Property for thumbnailImage")
    def addThumbnailImage(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultCharacterisation.addThumbnailImage argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataImage":
            self._thumbnailImage.append(value)
        else:
            strMessage = "ERROR! XSDataResultCharacterisation.addThumbnailImage argument is not XSDataImage but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getKappaReorientation(self): return self._kappaReorientation
    def setKappaReorientation(self, kappaReorientation):
        if kappaReorientation is None:
            ...
            strMessage = "ERROR! XSDataResultCharacterisation.setKappaReorientation argument is not XSDataResultControlKappa but %s" % kappaReorientation.__class__.__name__
            raise BaseException(strMessage)
    def delKappaReorientation(self): self._kappaReorientation = None
    kappaReorientation = property(getKappaReorientation, setKappaReorientation, delKappaReorientation, "Property for kappaReorientation")
...
class XSDataResultControlImageQualityIndicators(XSDataResult):
    def __init__(self, status=None, inputDozor=None, imageQualityIndicators=None):
        ...
        if inputDozor is None:
            ...
            strMessage = "ERROR! XSDataResultControlImageQualityIndicators constructor argument 'inputDozor' is not XSDataDozorInput but %s" % self._inputDozor.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'imageQualityIndicators' attribute
    def getImageQualityIndicators(self): return self._imageQualityIndicators
    def setImageQualityIndicators(self, imageQualityIndicators):
    ...
    def setInputDozor(self, inputDozor):
        if inputDozor is None:
            ...
            strMessage = "ERROR! XSDataResultControlImageQualityIndicators.setInputDozor argument is not XSDataDozorInput but %s" % inputDozor.__class__.__name__
            raise BaseException(strMessage)
...
class XSDataResultControlKappa(XSDataResult):
    def __init__(self, status=None, solution=None, logFile=None):
        ...
        if logFile is None:
            ...
            strMessage = "ERROR! XSDataResultControlKappa constructor argument 'logFile' is not XSDataFile but %s" % self._logFile.__class__.__name__
            raise BaseException(strMessage)
        if solution is None:
            self._solution = []
        elif solution.__class__.__name__ == "list":
            ...
            strMessage = "ERROR! XSDataResultControlKappa constructor argument 'solution' is not list but %s" % self._solution.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setLogFile(self, logFile):
        if logFile is None:
            ...
            strMessage = "ERROR! XSDataResultControlKappa.setLogFile argument is not XSDataFile but %s" % logFile.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setSolution(self, solution):
        if solution is None:
            ...
            strMessage = "ERROR! XSDataResultControlKappa.setSolution argument is not list but %s" % solution.__class__.__name__
            raise BaseException(strMessage)
    def delSolution(self): self._solution = None
    solution = property(getSolution, setSolution, delSolution, "Property for solution")
    def addSolution(self, value):
        if value is None:
            ...
            strMessage = "ERROR! XSDataResultControlKappa.addSolution argument is not XSDataKappaSolution but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertSolution(self, index, value):
        if index is None:
    ...
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultControlKappa is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
...
class XSDataResultStrategy(XSDataResult):
    ...
    def __init__(self, status=None, timeToReachHendersonLimit=None, sample=None, raddoseLogFile=None, collectionPlan=None, fbestLogFile=None, bestLogFile=None, bestGraphFile=None):
        XSDataResult.__init__(self, status)
        ...
        if fbestLogFile is None:
            ...
            strMessage = "ERROR! XSDataResultStrategy constructor argument 'fbestLogFile' is not XSDataFile but %s" % self._fbestLogFile.__class__.__name__
            raise BaseException(strMessage)
        ...
        if timeToReachHendersonLimit is None:
            ...
            strMessage = "ERROR! XSDataResultStrategy constructor argument 'timeToReachHendersonLimit' is not XSDataTime but %s" % self._timeToReachHendersonLimit.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setFbestLogFile(self, fbestLogFile):
        if fbestLogFile is None:
            ...
            strMessage = "ERROR! XSDataResultStrategy.setFbestLogFile argument is not XSDataFile but %s" % fbestLogFile.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getTimeToReachHendersonLimit(self): return self._timeToReachHendersonLimit
    def setTimeToReachHendersonLimit(self, timeToReachHendersonLimit):
        if timeToReachHendersonLimit is None:
            ...
            strMessage = "ERROR! XSDataResultStrategy.setTimeToReachHendersonLimit argument is not XSDataTime but %s" % timeToReachHendersonLimit.__class__.__name__
            raise BaseException(strMessage)
    def delTimeToReachHendersonLimit(self): self._timeToReachHendersonLimit = None
...
class XSDataSampleCrystal(XSDataSample):
    ...
    def __init__(self, susceptibility=None, omegaMin=None, size=None, shape=None, radiationDamageModelGamma=None, radiationDamageModelBeta=None, absorbedDoseRate=None, crystal=None):
        XSDataSample.__init__(self, susceptibility, omegaMin, size, shape, radiationDamageModelGamma, radiationDamageModelBeta, absorbedDoseRate)
        if crystal is None:
            self._crystal = None
        elif crystal.__class__.__name__ == "XSDataCrystal":
            self._crystal = crystal
...
class XSDataSampleCrystalMM(XSDataSampleCrystal):
    ...
    def __init__(self, susceptibility=None, omegaMin=None, size=None, shape=None, radiationDamageModelGamma=None, radiationDamageModelBeta=None, absorbedDoseRate=None, crystal=None, chemicalComposition=None):
        XSDataSampleCrystal.__init__(self, susceptibility, omegaMin, size, shape, radiationDamageModelGamma, radiationDamageModelBeta, absorbedDoseRate, crystal)
