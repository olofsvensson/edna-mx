...
class EDTestCasePluginExecuteMOSFLMIndexingv10_eiger4m(EDTestCasePluginExecuteMOSFLMv10):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecuteMOSFLMv10.__init__(self, "EDPluginMOSFLMIndexingv10")
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.strExecutionTestDataInputHome, "XSDataMOSFLMInputIndexing_eiger4m.xml"))
