...
from XSDataMXWaitFilev1_0                import XSDataResultMXWaitFile


class EDTestCasePluginExecuteMXWaitFilev1_0(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin MXWaitFilev1_0
    """

    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginMXWaitFilev1_0")
        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(),
                                               "XSConfiguration_MXWaitFile.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMXWaitFile_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultMXWaitFile_reference.xml"))
    ...
    def testExecute(self):
        ...
        ref = XSDataResultMXWaitFile.parseString(self.readAndParseFile(self.getReferenceDataOutputFile())).marshal()
