...
class EDTestCasePluginUnitDozorv1_1(EDTestCasePluginUnit):


    def __init__(self, _strTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginDozorv1_1")
    ...
    def test_generatePngPlots(self):
        edPlugin = self.getPlugin()
        plotmtvFile = os.path.join(self.strDataPath, "dozor_average.mtv")
        tmpDir = tempfile.mkdtemp(suffix="EDTestCasePluginUnitDozorv1_1_")
