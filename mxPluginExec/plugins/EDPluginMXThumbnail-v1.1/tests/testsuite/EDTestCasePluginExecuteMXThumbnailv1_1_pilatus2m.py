...
class EDTestCasePluginExecuteMXThumbnailv1_1_pilatus2m(EDTestCasePluginExecuteMXThumbnailv1_1):
    
    def __init__(self, _strTestName = None):
        EDTestCasePluginExecuteMXThumbnailv1_1.__init__(self, "EDPluginMXThumbnailv1_1")
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMXThumbnail_pilatus2m.xml"))
                 
    def preProcess(self):
        EDTestCasePluginExecuteMXThumbnailv1_1.preProcess(self)
        self.loadTestImage([ "ref-2m_RNASE_3_0001.cbf" ])
