...
class EDTestCasePluginExecuteXDSIndexingv1_0_FAE(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName="EDPluginXDSIndexingv1_0"):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputXDSIndexing_FAE.xml"))
