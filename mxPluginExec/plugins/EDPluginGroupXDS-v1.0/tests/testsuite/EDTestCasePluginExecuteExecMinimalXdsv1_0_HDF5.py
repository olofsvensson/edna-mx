...
class EDTestCasePluginExecuteExecMinimalXdsv1_0_HDF5(EDTestCasePluginExecute):
    """
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMinimalXds_HDF5.xml"))
    ...
    def testExecute(self):
        ...
        EDAssert.equal(output.succeeded.value, True, "HDF5 processing succeeded.")
