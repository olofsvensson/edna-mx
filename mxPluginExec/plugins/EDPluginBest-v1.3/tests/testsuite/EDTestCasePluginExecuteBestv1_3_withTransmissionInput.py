...
class EDTestCasePluginExecuteBestv1_3_withTransmissionInput(EDTestCasePluginExecuteBestv1_3):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBestv1_3_withTransmissionInput = EDTestCasePluginExecuteBestv1_3_withTransmissionInput("EDTestCasePluginExecuteBestv1_3_withTransmissionInput")
    edTestCasePluginExecuteBestv1_3_withTransmissionInput.execute()
