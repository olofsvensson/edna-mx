...
class EDTestCasePluginExecuteISPyBStoreAutoProcProgramAttachmentv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreAutoProcProgramAttachmentv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreAutoProcProgramAttachment_test.xml"))
    ...
    def testExecute(self):
        ...
        EDAssert.equal(True, xsDataResult.autoProcProgramAttachmentId is not None, "Attribute autoProcProgramAttachmentId in the result")
