...
class EDTestCasePluginExecuteISPyBSetImageQualityIndicatorsPlotv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBSetImageQualityIndicatorsPlotv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputSetImageQualityIndicatorsPlot_test.xml"))
