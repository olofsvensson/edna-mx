...
class EDTestCasePluginExecuteISPyBStoreWorkflowv1_4_update(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreWorkflow_update.xml"))
