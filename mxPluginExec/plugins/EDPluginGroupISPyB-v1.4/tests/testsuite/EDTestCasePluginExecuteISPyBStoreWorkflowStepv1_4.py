...
class EDTestCasePluginExecuteISPyBStoreWorkflowStepv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreWorkflowStepv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreWorkflowStep_test.xml"))
...
#        if xsDataResult.workflowStepId is None:
#            bAttributeExists = False
#        EDAssert.equal(True, bAttributeExists, "Attribute workflowStepId in the result")
