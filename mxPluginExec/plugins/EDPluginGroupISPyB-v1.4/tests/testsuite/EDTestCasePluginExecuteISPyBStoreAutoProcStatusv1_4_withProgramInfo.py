...
class EDTestCasePluginExecuteISPyBStoreAutoProcStatusv1_4_withProgramInfo(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreAutoProcStatus_withProgramInfo.xml"))
