...
class EDTestCasePluginExecuteISPyBGetPdbFilePathv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBGetPdbFilePathv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputGetPdbFilePath_test.xml"))
