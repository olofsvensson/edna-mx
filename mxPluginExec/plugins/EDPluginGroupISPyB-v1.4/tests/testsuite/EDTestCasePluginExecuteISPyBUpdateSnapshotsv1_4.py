...
class EDTestCasePluginExecuteISPyBUpdateSnapshotsv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBUpdateSnapshotsv1_4")
...
#        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(), "XSConfiguration_ESRF_testDataBase.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputUpdateSnapshots_test.xml"))
    ...
    def testExecute(self):
        ...
        EDAssert.equal(True, bAttributeExists, "dataCollectionId in the result")
