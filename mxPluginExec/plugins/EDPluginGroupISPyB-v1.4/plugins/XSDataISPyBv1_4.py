...
#
# Generated Thu Sep 6 09:59::27 2018 by EDGenerateDS.
#
...
class AutoProcProgram(object):
    def __init__(self, processingEnvironment=None, processingEndTime=None, processingStartTime=None, processingMessage=None, processingStatus=None, processingPrograms=None, processingCommandLine=None, autoProcProgramId=None):
        ...
        self._processingStatus = str(processingStatus)
    ...
    def exportChildren(self, outfile, level, name_='AutoProcProgram'):
        ...
        if self._processingStatus is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<processingStatus>%s</processingStatus>\n' % self._processingStatus))
        else:
            warnEmptyAttribute("processingStatus", "string")
...
class AutoProcProgramAttachment(object):
    def __init__(self, recordTimeStamp=None, filePath=None, fileName=None, fileType=None, autoProcProgramId=None, autoProcProgramAttachmentId=None):
...
class AutoProcScaling(object):
    def __init__(self, resolutionEllipsoidValue3=None, resolutionEllipsoidValue2=None, resolutionEllipsoidValue1=None, resolutionEllipsoidAxis33=None, resolutionEllipsoidAxis32=None, resolutionEllipsoidAxis31=None, resolutionEllipsoidAxis23=None, resolutionEllipsoidAxis22=None, resolutionEllipsoidAxis21=None, resolutionEllipsoidAxis13=None, resolutionEllipsoidAxis12=None, resolutionEllipsoidAxis11=None, recordTimeStamp=None, autoProcScalingId=None):
        if autoProcScalingId is None:
            self._autoProcScalingId = None
        else:
            self._autoProcScalingId = int(autoProcScalingId)
        self._recordTimeStamp = str(recordTimeStamp)
        if resolutionEllipsoidAxis11 is None:
            self._resolutionEllipsoidAxis11 = None
        else:
            self._resolutionEllipsoidAxis11 = float(resolutionEllipsoidAxis11)
        if resolutionEllipsoidAxis12 is None:
            self._resolutionEllipsoidAxis12 = None
        else:
            self._resolutionEllipsoidAxis12 = float(resolutionEllipsoidAxis12)
        if resolutionEllipsoidAxis13 is None:
            self._resolutionEllipsoidAxis13 = None
        else:
            self._resolutionEllipsoidAxis13 = float(resolutionEllipsoidAxis13)
        if resolutionEllipsoidAxis21 is None:
            self._resolutionEllipsoidAxis21 = None
        else:
            self._resolutionEllipsoidAxis21 = float(resolutionEllipsoidAxis21)
        if resolutionEllipsoidAxis22 is None:
            self._resolutionEllipsoidAxis22 = None
        else:
            self._resolutionEllipsoidAxis22 = float(resolutionEllipsoidAxis22)
        if resolutionEllipsoidAxis23 is None:
            self._resolutionEllipsoidAxis23 = None
        else:
            self._resolutionEllipsoidAxis23 = float(resolutionEllipsoidAxis23)
        if resolutionEllipsoidAxis31 is None:
            self._resolutionEllipsoidAxis31 = None
        else:
            self._resolutionEllipsoidAxis31 = float(resolutionEllipsoidAxis31)
        if resolutionEllipsoidAxis32 is None:
            self._resolutionEllipsoidAxis32 = None
        else:
            self._resolutionEllipsoidAxis32 = float(resolutionEllipsoidAxis32)
        if resolutionEllipsoidAxis33 is None:
            self._resolutionEllipsoidAxis33 = None
        else:
            self._resolutionEllipsoidAxis33 = float(resolutionEllipsoidAxis33)
        if resolutionEllipsoidValue1 is None:
            self._resolutionEllipsoidValue1 = None
        else:
            self._resolutionEllipsoidValue1 = float(resolutionEllipsoidValue1)
        if resolutionEllipsoidValue2 is None:
            self._resolutionEllipsoidValue2 = None
        else:
            self._resolutionEllipsoidValue2 = float(resolutionEllipsoidValue2)
        if resolutionEllipsoidValue3 is None:
            self._resolutionEllipsoidValue3 = None
        else:
            self._resolutionEllipsoidValue3 = float(resolutionEllipsoidValue3)
    ...
    def delRecordTimeStamp(self): self._recordTimeStamp = None
    recordTimeStamp = property(getRecordTimeStamp, setRecordTimeStamp, delRecordTimeStamp, "Property for recordTimeStamp")
    # Methods and properties for the 'resolutionEllipsoidAxis11' attribute
    def getResolutionEllipsoidAxis11(self): return self._resolutionEllipsoidAxis11
    def setResolutionEllipsoidAxis11(self, resolutionEllipsoidAxis11):
        if resolutionEllipsoidAxis11 is None:
            self._resolutionEllipsoidAxis11 = None
        else:
            self._resolutionEllipsoidAxis11 = float(resolutionEllipsoidAxis11)
    def delResolutionEllipsoidAxis11(self): self._resolutionEllipsoidAxis11 = None
    resolutionEllipsoidAxis11 = property(getResolutionEllipsoidAxis11, setResolutionEllipsoidAxis11, delResolutionEllipsoidAxis11, "Property for resolutionEllipsoidAxis11")
    # Methods and properties for the 'resolutionEllipsoidAxis12' attribute
    def getResolutionEllipsoidAxis12(self): return self._resolutionEllipsoidAxis12
    def setResolutionEllipsoidAxis12(self, resolutionEllipsoidAxis12):
        if resolutionEllipsoidAxis12 is None:
            self._resolutionEllipsoidAxis12 = None
        else:
            self._resolutionEllipsoidAxis12 = float(resolutionEllipsoidAxis12)
    def delResolutionEllipsoidAxis12(self): self._resolutionEllipsoidAxis12 = None
    resolutionEllipsoidAxis12 = property(getResolutionEllipsoidAxis12, setResolutionEllipsoidAxis12, delResolutionEllipsoidAxis12, "Property for resolutionEllipsoidAxis12")
    # Methods and properties for the 'resolutionEllipsoidAxis13' attribute
    def getResolutionEllipsoidAxis13(self): return self._resolutionEllipsoidAxis13
    def setResolutionEllipsoidAxis13(self, resolutionEllipsoidAxis13):
        if resolutionEllipsoidAxis13 is None:
            self._resolutionEllipsoidAxis13 = None
        else:
            self._resolutionEllipsoidAxis13 = float(resolutionEllipsoidAxis13)
    def delResolutionEllipsoidAxis13(self): self._resolutionEllipsoidAxis13 = None
    resolutionEllipsoidAxis13 = property(getResolutionEllipsoidAxis13, setResolutionEllipsoidAxis13, delResolutionEllipsoidAxis13, "Property for resolutionEllipsoidAxis13")
    # Methods and properties for the 'resolutionEllipsoidAxis21' attribute
    def getResolutionEllipsoidAxis21(self): return self._resolutionEllipsoidAxis21
    def setResolutionEllipsoidAxis21(self, resolutionEllipsoidAxis21):
        if resolutionEllipsoidAxis21 is None:
            self._resolutionEllipsoidAxis21 = None
        else:
            self._resolutionEllipsoidAxis21 = float(resolutionEllipsoidAxis21)
    def delResolutionEllipsoidAxis21(self): self._resolutionEllipsoidAxis21 = None
    resolutionEllipsoidAxis21 = property(getResolutionEllipsoidAxis21, setResolutionEllipsoidAxis21, delResolutionEllipsoidAxis21, "Property for resolutionEllipsoidAxis21")
    # Methods and properties for the 'resolutionEllipsoidAxis22' attribute
    def getResolutionEllipsoidAxis22(self): return self._resolutionEllipsoidAxis22
    def setResolutionEllipsoidAxis22(self, resolutionEllipsoidAxis22):
        if resolutionEllipsoidAxis22 is None:
            self._resolutionEllipsoidAxis22 = None
        else:
            self._resolutionEllipsoidAxis22 = float(resolutionEllipsoidAxis22)
    def delResolutionEllipsoidAxis22(self): self._resolutionEllipsoidAxis22 = None
    resolutionEllipsoidAxis22 = property(getResolutionEllipsoidAxis22, setResolutionEllipsoidAxis22, delResolutionEllipsoidAxis22, "Property for resolutionEllipsoidAxis22")
    # Methods and properties for the 'resolutionEllipsoidAxis23' attribute
    def getResolutionEllipsoidAxis23(self): return self._resolutionEllipsoidAxis23
    def setResolutionEllipsoidAxis23(self, resolutionEllipsoidAxis23):
        if resolutionEllipsoidAxis23 is None:
            self._resolutionEllipsoidAxis23 = None
        else:
            self._resolutionEllipsoidAxis23 = float(resolutionEllipsoidAxis23)
    def delResolutionEllipsoidAxis23(self): self._resolutionEllipsoidAxis23 = None
    resolutionEllipsoidAxis23 = property(getResolutionEllipsoidAxis23, setResolutionEllipsoidAxis23, delResolutionEllipsoidAxis23, "Property for resolutionEllipsoidAxis23")
    # Methods and properties for the 'resolutionEllipsoidAxis31' attribute
    def getResolutionEllipsoidAxis31(self): return self._resolutionEllipsoidAxis31
    def setResolutionEllipsoidAxis31(self, resolutionEllipsoidAxis31):
        if resolutionEllipsoidAxis31 is None:
            self._resolutionEllipsoidAxis31 = None
        else:
            self._resolutionEllipsoidAxis31 = float(resolutionEllipsoidAxis31)
    def delResolutionEllipsoidAxis31(self): self._resolutionEllipsoidAxis31 = None
    resolutionEllipsoidAxis31 = property(getResolutionEllipsoidAxis31, setResolutionEllipsoidAxis31, delResolutionEllipsoidAxis31, "Property for resolutionEllipsoidAxis31")
    # Methods and properties for the 'resolutionEllipsoidAxis32' attribute
    def getResolutionEllipsoidAxis32(self): return self._resolutionEllipsoidAxis32
    def setResolutionEllipsoidAxis32(self, resolutionEllipsoidAxis32):
        if resolutionEllipsoidAxis32 is None:
            self._resolutionEllipsoidAxis32 = None
        else:
            self._resolutionEllipsoidAxis32 = float(resolutionEllipsoidAxis32)
    def delResolutionEllipsoidAxis32(self): self._resolutionEllipsoidAxis32 = None
    resolutionEllipsoidAxis32 = property(getResolutionEllipsoidAxis32, setResolutionEllipsoidAxis32, delResolutionEllipsoidAxis32, "Property for resolutionEllipsoidAxis32")
    # Methods and properties for the 'resolutionEllipsoidAxis33' attribute
    def getResolutionEllipsoidAxis33(self): return self._resolutionEllipsoidAxis33
    def setResolutionEllipsoidAxis33(self, resolutionEllipsoidAxis33):
        if resolutionEllipsoidAxis33 is None:
            self._resolutionEllipsoidAxis33 = None
        else:
            self._resolutionEllipsoidAxis33 = float(resolutionEllipsoidAxis33)
    def delResolutionEllipsoidAxis33(self): self._resolutionEllipsoidAxis33 = None
    resolutionEllipsoidAxis33 = property(getResolutionEllipsoidAxis33, setResolutionEllipsoidAxis33, delResolutionEllipsoidAxis33, "Property for resolutionEllipsoidAxis33")
    # Methods and properties for the 'resolutionEllipsoidValue1' attribute
    def getResolutionEllipsoidValue1(self): return self._resolutionEllipsoidValue1
    def setResolutionEllipsoidValue1(self, resolutionEllipsoidValue1):
        if resolutionEllipsoidValue1 is None:
            self._resolutionEllipsoidValue1 = None
        else:
            self._resolutionEllipsoidValue1 = float(resolutionEllipsoidValue1)
    def delResolutionEllipsoidValue1(self): self._resolutionEllipsoidValue1 = None
    resolutionEllipsoidValue1 = property(getResolutionEllipsoidValue1, setResolutionEllipsoidValue1, delResolutionEllipsoidValue1, "Property for resolutionEllipsoidValue1")
    # Methods and properties for the 'resolutionEllipsoidValue2' attribute
    def getResolutionEllipsoidValue2(self): return self._resolutionEllipsoidValue2
    def setResolutionEllipsoidValue2(self, resolutionEllipsoidValue2):
        if resolutionEllipsoidValue2 is None:
            self._resolutionEllipsoidValue2 = None
        else:
            self._resolutionEllipsoidValue2 = float(resolutionEllipsoidValue2)
    def delResolutionEllipsoidValue2(self): self._resolutionEllipsoidValue2 = None
    resolutionEllipsoidValue2 = property(getResolutionEllipsoidValue2, setResolutionEllipsoidValue2, delResolutionEllipsoidValue2, "Property for resolutionEllipsoidValue2")
    # Methods and properties for the 'resolutionEllipsoidValue3' attribute
    def getResolutionEllipsoidValue3(self): return self._resolutionEllipsoidValue3
    def setResolutionEllipsoidValue3(self, resolutionEllipsoidValue3):
        if resolutionEllipsoidValue3 is None:
            self._resolutionEllipsoidValue3 = None
        else:
            self._resolutionEllipsoidValue3 = float(resolutionEllipsoidValue3)
    def delResolutionEllipsoidValue3(self): self._resolutionEllipsoidValue3 = None
    resolutionEllipsoidValue3 = property(getResolutionEllipsoidValue3, setResolutionEllipsoidValue3, delResolutionEllipsoidValue3, "Property for resolutionEllipsoidValue3")
    ...
    def exportChildren(self, outfile, level, name_='AutoProcScaling'):
        ...
        if self._recordTimeStamp is not None:
            ...
            warnEmptyAttribute("recordTimeStamp", "string")
        if self._resolutionEllipsoidAxis11 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis11>%e</resolutionEllipsoidAxis11>\n' % self._resolutionEllipsoidAxis11))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis11", "float")
        if self._resolutionEllipsoidAxis12 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis12>%e</resolutionEllipsoidAxis12>\n' % self._resolutionEllipsoidAxis12))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis12", "float")
        if self._resolutionEllipsoidAxis13 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis13>%e</resolutionEllipsoidAxis13>\n' % self._resolutionEllipsoidAxis13))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis13", "float")
        if self._resolutionEllipsoidAxis21 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis21>%e</resolutionEllipsoidAxis21>\n' % self._resolutionEllipsoidAxis21))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis21", "float")
        if self._resolutionEllipsoidAxis22 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis22>%e</resolutionEllipsoidAxis22>\n' % self._resolutionEllipsoidAxis22))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis22", "float")
        if self._resolutionEllipsoidAxis23 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis23>%e</resolutionEllipsoidAxis23>\n' % self._resolutionEllipsoidAxis23))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis23", "float")
        if self._resolutionEllipsoidAxis31 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis31>%e</resolutionEllipsoidAxis31>\n' % self._resolutionEllipsoidAxis31))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis31", "float")
        if self._resolutionEllipsoidAxis32 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis32>%e</resolutionEllipsoidAxis32>\n' % self._resolutionEllipsoidAxis32))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis32", "float")
        if self._resolutionEllipsoidAxis33 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidAxis33>%e</resolutionEllipsoidAxis33>\n' % self._resolutionEllipsoidAxis33))
        else:
            warnEmptyAttribute("resolutionEllipsoidAxis33", "float")
        if self._resolutionEllipsoidValue1 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidValue1>%e</resolutionEllipsoidValue1>\n' % self._resolutionEllipsoidValue1))
        else:
            warnEmptyAttribute("resolutionEllipsoidValue1", "float")
        if self._resolutionEllipsoidValue2 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidValue2>%e</resolutionEllipsoidValue2>\n' % self._resolutionEllipsoidValue2))
        else:
            warnEmptyAttribute("resolutionEllipsoidValue2", "float")
        if self._resolutionEllipsoidValue3 is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<resolutionEllipsoidValue3>%e</resolutionEllipsoidValue3>\n' % self._resolutionEllipsoidValue3))
        else:
            warnEmptyAttribute("resolutionEllipsoidValue3", "float")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'resolutionEllipsoidAxis11':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis11 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis12':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis12 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis13':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis13 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis21':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis21 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis22':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis22 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis23':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis23 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis31':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis31 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis32':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis32 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidAxis33':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidAxis33 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidValue1':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidValue1 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidValue2':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidValue2 = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resolutionEllipsoidValue3':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._resolutionEllipsoidValue3 = fval_
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
...
class AutoProcScalingStatistics(object):
    def __init__(self, anomalousCompletenessEllipsoidal=None, completenessEllipsoidal=None, anomalousCompletenessSpherical=None, completenessSpherical=None, isa=None, sigAno=None, ccAno=None, ccHalf=None, autoProcScalingId=None, anomalous=None, recordTimeStamp=None, anomalousMultiplicity=None, anomalousCompleteness=None, multiplicity=None, completeness=None, meanIOverSigI=None, ntotalUniqueObservations=None, nTotalObservations=None, fractionalPartialBias=None, rpimAllIplusIminus=None, rpimWithinIplusIminus=None, rmeasAllIplusIminus=None, rmeasWithinIplusIminus=None, rMerge=None, resolutionLimitHigh=None, resolutionLimitLow=None, comments=None, scalingStatisticsType=None, autoProcScalingStatisticsId=None):
        ...
        if ccAno is None:
            ...
            self._ccAno = float(ccAno)
        if sigAno is None:
            self._sigAno = None
        else:
            self._sigAno = float(sigAno)
        if isa is None:
            self._isa = None
        else:
            self._isa = float(isa)
        if completenessSpherical is None:
            self._completenessSpherical = None
        else:
            self._completenessSpherical = float(completenessSpherical)
        if anomalousCompletenessSpherical is None:
            self._anomalousCompletenessSpherical = None
        else:
            self._anomalousCompletenessSpherical = float(anomalousCompletenessSpherical)
        if completenessEllipsoidal is None:
            self._completenessEllipsoidal = None
        else:
            self._completenessEllipsoidal = float(completenessEllipsoidal)
        if anomalousCompletenessEllipsoidal is None:
            self._anomalousCompletenessEllipsoidal = None
        else:
            self._anomalousCompletenessEllipsoidal = float(anomalousCompletenessEllipsoidal)
    ...
    # Methods and properties for the 'ccAno' attribute
    def getCcAno(self): return self._ccAno
    def setCcAno(self, ccAno):
        if ccAno is None:
            self._ccAno = None
        else:
            self._ccAno = float(ccAno)
    def delCcAno(self): self._ccAno = None
    ccAno = property(getCcAno, setCcAno, delCcAno, "Property for ccAno")
    # Methods and properties for the 'sigAno' attribute
    def getSigAno(self): return self._sigAno
    def setSigAno(self, sigAno):
        if sigAno is None:
            self._sigAno = None
        else:
            self._sigAno = float(sigAno)
    def delSigAno(self): self._sigAno = None
    sigAno = property(getSigAno, setSigAno, delSigAno, "Property for sigAno")
    # Methods and properties for the 'isa' attribute
    def getIsa(self): return self._isa
    def setIsa(self, isa):
        if isa is None:
            self._isa = None
        else:
            self._isa = float(isa)
    def delIsa(self): self._isa = None
    isa = property(getIsa, setIsa, delIsa, "Property for isa")
    # Methods and properties for the 'completenessSpherical' attribute
    def getCompletenessSpherical(self): return self._completenessSpherical
    def setCompletenessSpherical(self, completenessSpherical):
        if completenessSpherical is None:
            self._completenessSpherical = None
        else:
            self._completenessSpherical = float(completenessSpherical)
    def delCompletenessSpherical(self): self._completenessSpherical = None
    completenessSpherical = property(getCompletenessSpherical, setCompletenessSpherical, delCompletenessSpherical, "Property for completenessSpherical")
    # Methods and properties for the 'anomalousCompletenessSpherical' attribute
    def getAnomalousCompletenessSpherical(self): return self._anomalousCompletenessSpherical
    def setAnomalousCompletenessSpherical(self, anomalousCompletenessSpherical):
        if anomalousCompletenessSpherical is None:
            self._anomalousCompletenessSpherical = None
        else:
            self._anomalousCompletenessSpherical = float(anomalousCompletenessSpherical)
    def delAnomalousCompletenessSpherical(self): self._anomalousCompletenessSpherical = None
    anomalousCompletenessSpherical = property(getAnomalousCompletenessSpherical, setAnomalousCompletenessSpherical, delAnomalousCompletenessSpherical, "Property for anomalousCompletenessSpherical")
    # Methods and properties for the 'completenessEllipsoidal' attribute
    def getCompletenessEllipsoidal(self): return self._completenessEllipsoidal
    def setCompletenessEllipsoidal(self, completenessEllipsoidal):
        if completenessEllipsoidal is None:
            self._completenessEllipsoidal = None
        else:
            self._completenessEllipsoidal = float(completenessEllipsoidal)
    def delCompletenessEllipsoidal(self): self._completenessEllipsoidal = None
    completenessEllipsoidal = property(getCompletenessEllipsoidal, setCompletenessEllipsoidal, delCompletenessEllipsoidal, "Property for completenessEllipsoidal")
    # Methods and properties for the 'anomalousCompletenessEllipsoidal' attribute
    def getAnomalousCompletenessEllipsoidal(self): return self._anomalousCompletenessEllipsoidal
    def setAnomalousCompletenessEllipsoidal(self, anomalousCompletenessEllipsoidal):
        if anomalousCompletenessEllipsoidal is None:
            self._anomalousCompletenessEllipsoidal = None
        else:
            self._anomalousCompletenessEllipsoidal = float(anomalousCompletenessEllipsoidal)
    def delAnomalousCompletenessEllipsoidal(self): self._anomalousCompletenessEllipsoidal = None
    anomalousCompletenessEllipsoidal = property(getAnomalousCompletenessEllipsoidal, setAnomalousCompletenessEllipsoidal, delAnomalousCompletenessEllipsoidal, "Property for anomalousCompletenessEllipsoidal")
    ...
    def exportChildren(self, outfile, level, name_='AutoProcScalingStatistics'):
        ...
        if self._autoProcScalingId is not None:
            ...
            warnEmptyAttribute("autoProcScalingId", "integer")
        if self._ccHalf is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<ccHalf>%e</ccHalf>\n' % self._ccHalf))
        else:
            warnEmptyAttribute("ccHalf", "float")
        if self._ccAno is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<ccAno>%e</ccAno>\n' % self._ccAno))
        else:
            warnEmptyAttribute("ccAno", "float")
        if self._sigAno is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<sigAno>%e</sigAno>\n' % self._sigAno))
        else:
            warnEmptyAttribute("sigAno", "float")
        if self._isa is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<isa>%e</isa>\n' % self._isa))
        else:
            warnEmptyAttribute("isa", "float")
        if self._completenessSpherical is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<completenessSpherical>%e</completenessSpherical>\n' % self._completenessSpherical))
        else:
            warnEmptyAttribute("completenessSpherical", "float")
        if self._anomalousCompletenessSpherical is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<anomalousCompletenessSpherical>%e</anomalousCompletenessSpherical>\n' % self._anomalousCompletenessSpherical))
        else:
            warnEmptyAttribute("anomalousCompletenessSpherical", "float")
        if self._completenessEllipsoidal is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<completenessEllipsoidal>%e</completenessEllipsoidal>\n' % self._completenessEllipsoidal))
        else:
            warnEmptyAttribute("completenessEllipsoidal", "float")
        if self._anomalousCompletenessEllipsoidal is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<anomalousCompletenessEllipsoidal>%e</anomalousCompletenessEllipsoidal>\n' % self._anomalousCompletenessEllipsoidal))
        else:
            warnEmptyAttribute("anomalousCompletenessEllipsoidal", "float")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'completenessSpherical':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._completenessSpherical = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'anomalousCompletenessSpherical':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._anomalousCompletenessSpherical = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'completenessEllipsoidal':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._completenessEllipsoidal = fval_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'anomalousCompletenessEllipsoidal':
            if child_.firstChild:
                sval_ = child_.firstChild.nodeValue
                try:
                    fval_ = float(sval_)
                    ...
                    raise ValueError('requires float (or double) -- %s' % child_.toxml())
                self._anomalousCompletenessEllipsoidal = fval_
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
...
class XSDataISPyBDataCollection(object):
    ...
    # Methods and properties for the 'flux_end' attribute
    def getFlux_end(self): return self._flux_end
    def setFlux_end(self, flux_end):
        if flux_end is None:
            self._flux_end = None
        else:
            self._flux_end = float(flux_end)
    def delFlux_end(self): self._flux_end = None
    flux_end = property(getFlux_end, setFlux_end, delFlux_end, "Property for flux_end")
    ...
    def exportChildren(self, outfile, level, name_='XSDataISPyBDataCollection'):
        ...
        if self._flux_end is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<flux_end>%e</flux_end>\n' % self._flux_end))
        else:
            warnEmptyAttribute("flux_end", "float")
...
class XSDataISPyBDiffractionPlan(XSData):
    def __init__(self, strategyOption=None, anomalousScatterer=None, screeningResolution=None, requiredResolution=None, requiredMultiplicity=None, requiredCompleteness=None, radiationSensitivityGamma=None, radiationSensitivityBeta=None, radiationSensitivity=None, preferredBeamDiameter=None, preferredBeamSizeY=None, preferredBeamSizeX=None, oscillationRange=None, observedResolution=None, numberOfPositions=None, minOscWidth=None, minimalResolution=None, minDimAccrossSpindleAxis=None, maximalResolution=None, maxDimAccrossSpindleAxis=None, kappaStrategyOption=None, forcedSpaceGroup=None, exposureTime=None, experimentKind=None, estimateRadiationDamage=None, diffractionPlanId=None, complexity=None, comments=None, axisStart=None, axisRange=None, anomalousData=None, aimedResolution=None, aimedMultiplicity=None, aimedIOverSigmaAtHighestResolution=None, aimedCompleteness=None):
        ...
        if axisRange is None:
            ...
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'axisRange' is not XSDataDouble but %s" % self._axisRange.__class__.__name__
            raise BaseException(strMessage)
        if axisStart is None:
            self._axisStart = None
            ...
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'axisStart' is not XSDataDouble but %s" % self._axisStart.__class__.__name__
            raise BaseException(strMessage)
        if comments is None:
            self._comments = None
        ...
        if minOscWidth is None:
            self._minOscWidth = None
        elif minOscWidth.__class__.__name__ == "XSDataDouble":
            self._minOscWidth = minOscWidth
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'minOscWidth' is not XSDataDouble but %s" % self._minOscWidth.__class__.__name__
            raise BaseException(strMessage)
        ...
        if preferredBeamSizeY is None:
            ...
            raise BaseException(strMessage)
        if preferredBeamDiameter is None:
            self._preferredBeamDiameter = None
        elif preferredBeamDiameter.__class__.__name__ == "XSDataDouble":
            self._preferredBeamDiameter = preferredBeamDiameter
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'preferredBeamDiameter' is not XSDataDouble but %s" % self._preferredBeamDiameter.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setAxisRange(self, axisRange):
        if axisRange is None:
            ...
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setAxisRange argument is not XSDataDouble but %s" % axisRange.__class__.__name__
            raise BaseException(strMessage)
    def delAxisRange(self): self._axisRange = None
    axisRange = property(getAxisRange, setAxisRange, delAxisRange, "Property for axisRange")
    # Methods and properties for the 'axisStart' attribute
    ...
    def setAxisStart(self, axisStart):
        if axisStart is None:
            ...
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setAxisStart argument is not XSDataDouble but %s" % axisStart.__class__.__name__
            raise BaseException(strMessage)
    def delAxisStart(self): self._axisStart = None
    axisStart = property(getAxisStart, setAxisStart, delAxisStart, "Property for axisStart")
    # Methods and properties for the 'comments' attribute
    ...
    # Methods and properties for the 'minOscWidth' attribute
    def getMinOscWidth(self): return self._minOscWidth
    def setMinOscWidth(self, minOscWidth):
        if minOscWidth is None:
            self._minOscWidth = None
        elif minOscWidth.__class__.__name__ == "XSDataDouble":
            self._minOscWidth = minOscWidth
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setMinOscWidth argument is not XSDataDouble but %s" % minOscWidth.__class__.__name__
            raise BaseException(strMessage)
    def delMinOscWidth(self): self._minOscWidth = None
    minOscWidth = property(getMinOscWidth, setMinOscWidth, delMinOscWidth, "Property for minOscWidth")
    ...
    # Methods and properties for the 'preferredBeamDiameter' attribute
    def getPreferredBeamDiameter(self): return self._preferredBeamDiameter
    def setPreferredBeamDiameter(self, preferredBeamDiameter):
        if preferredBeamDiameter is None:
            self._preferredBeamDiameter = None
        elif preferredBeamDiameter.__class__.__name__ == "XSDataDouble":
            self._preferredBeamDiameter = preferredBeamDiameter
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setPreferredBeamDiameter argument is not XSDataDouble but %s" % preferredBeamDiameter.__class__.__name__
            raise BaseException(strMessage)
    def delPreferredBeamDiameter(self): self._preferredBeamDiameter = None
    preferredBeamDiameter = property(getPreferredBeamDiameter, setPreferredBeamDiameter, delPreferredBeamDiameter, "Property for preferredBeamDiameter")
    ...
    def exportChildren(self, outfile, level, name_='XSDataISPyBDiffractionPlan'):
        ...
        if self._minOscWidth is not None:
            self.minOscWidth.export(outfile, level, name_='minOscWidth')
        ...
        if self._preferredBeamDiameter is not None:
            self.preferredBeamDiameter.export(outfile, level, name_='preferredBeamDiameter')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'minOscWidth':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setMinOscWidth(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'preferredBeamDiameter':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setPreferredBeamDiameter(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
...
class XSDataISPyBImageQualityIndicators(XSData):
    def __init__(self, dozor_score=None, totalIntegratedSignal=None, spotTotal=None, signalRangeMin=None, signalRangeMax=None, signalRangeAverage=None, saturationRangeMin=None, saturationRangeMax=None, saturationRangeAverage=None, pctSaturationTop50Peaks=None, method2Res=None, method1Res=None, maxUnitCell=None, inResolutionOvrlSpots=None, inResTotal=None, image=None, iceRings=None, goodBraggCandidates=None, binPopCutOffMethod2Res=None):
        ...
        if dozor_score is None:
            ...
            strMessage = "ERROR! XSDataISPyBImageQualityIndicators constructor argument 'dozor_score' is not XSDataDouble but %s" % self._dozor_score.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getDozor_score(self): return self._dozor_score
    def setDozor_score(self, dozor_score):
        if dozor_score is None:
            ...
            strMessage = "ERROR! XSDataISPyBImageQualityIndicators.setDozor_score argument is not XSDataDouble but %s" % dozor_score.__class__.__name__
            raise BaseException(strMessage)
    def delDozor_score(self): self._dozor_score = None
    dozor_score = property(getDozor_score, setDozor_score, delDozor_score, "Property for dozor_score")
...
class XSDataISPyBScreening(XSData):
    def __init__(self, xmlSampleInformation=None, shortComments=None, comments=None, programVersion=None, timeStamp=None, diffractionplanId=None, dataCollectionGroupId=None, screeningId=None):
        XSData.__init__(self, )
        ...
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataISPyBScreening constructor argument 'dataCollectionGroupId' is not XSDataInteger but %s" % self._dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
        if diffractionplanId is None:
            self._diffractionplanId = None
        elif diffractionplanId.__class__.__name__ == "XSDataInteger":
    ...
    def setDataCollectionGroupId(self, dataCollectionGroupId):
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataISPyBScreening.setDataCollectionGroupId argument is not XSDataInteger but %s" % dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
...
class XSDataISPyBScreeningStrategyWedge(XSData):
    def __init__(self, wavelength=None, comments=None, chi=None, kappa=None, phi=None, numberOfImages=None, doseTotal=None, multiplicity=None, completeness=None, resolution=None, wedgeNumber=None, screeningStrategyOutputId=None, screeningStrategyId=None, screeningStrategyWedgeId=None):
        XSData.__init__(self, )
        if screeningStrategyWedgeId is None:
            self._screeningStrategyWedgeId = None
        elif screeningStrategyWedgeId.__class__.__name__ == "XSDataInteger":
        ...
        if chi is None:
            ...
            strMessage = "ERROR! XSDataISPyBScreeningStrategyWedge constructor argument 'chi' is not XSDataDouble but %s" % self._chi.__class__.__name__
            raise BaseException(strMessage)
        if comments is None:
            self._comments = None
        elif comments.__class__.__name__ == "XSDataString":
    ...
    def setChi(self, chi):
        if chi is None:
            ...
            strMessage = "ERROR! XSDataISPyBScreeningStrategyWedge.setChi argument is not XSDataDouble but %s" % chi.__class__.__name__
            raise BaseException(strMessage)
...
class XSDataInputISPyBGetPdbFilePath(XSDataInput):
    def __init__(self, configuration=None, dataCollectionId=None):
        XSDataInput.__init__(self, configuration)
        if dataCollectionId is None:
            self._dataCollectionId = None
            ...
            strMessage = "ERROR! XSDataInputISPyBGetPdbFilePath constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBGetPdbFilePath.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    def export(self, outfile, level, name_='XSDataInputISPyBGetPdbFilePath'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBGetPdbFilePath'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._dataCollectionId is not None:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBGetPdbFilePath" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBGetPdbFilePath' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBGetPdbFilePath is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBGetPdbFilePath.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBGetPdbFilePath()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBGetPdbFilePath" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBGetPdbFilePath
...
class XSDataInputISPyBStoreWorkflowStep(XSDataInput):
    def __init__(self, configuration=None, recordTimeStamp=None, maxDozorScore=None, crystalSizeZ=None, crystalSizeY=None, crystalSizeX=None, comments=None, resultFilePath=None, htmlResultFilePath=None, imageResultFilePath=None, folderPath=None, status=None, workflowStepType=None, workflowId=None):
        XSDataInput.__init__(self, configuration)
        if workflowId is None:
            self._workflowId = None
        elif workflowId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'workflowId' is not XSDataInteger but %s" % self._workflowId.__class__.__name__
            raise BaseException(strMessage)
        if workflowStepType is None:
            self._workflowStepType = None
        elif workflowStepType.__class__.__name__ == "XSDataString":
            self._workflowStepType = workflowStepType
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'workflowStepType' is not XSDataString but %s" % self._workflowStepType.__class__.__name__
            raise BaseException(strMessage)
        if status is None:
            self._status = None
        elif status.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'status' is not XSDataString but %s" % self._status.__class__.__name__
            raise BaseException(strMessage)
        if folderPath is None:
            self._folderPath = None
        elif folderPath.__class__.__name__ == "XSDataString":
            self._folderPath = folderPath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'folderPath' is not XSDataString but %s" % self._folderPath.__class__.__name__
            raise BaseException(strMessage)
        if imageResultFilePath is None:
            self._imageResultFilePath = None
        elif imageResultFilePath.__class__.__name__ == "XSDataString":
            self._imageResultFilePath = imageResultFilePath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'imageResultFilePath' is not XSDataString but %s" % self._imageResultFilePath.__class__.__name__
            raise BaseException(strMessage)
        if htmlResultFilePath is None:
            self._htmlResultFilePath = None
        elif htmlResultFilePath.__class__.__name__ == "XSDataString":
            self._htmlResultFilePath = htmlResultFilePath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'htmlResultFilePath' is not XSDataString but %s" % self._htmlResultFilePath.__class__.__name__
            raise BaseException(strMessage)
        if resultFilePath is None:
            self._resultFilePath = None
        elif resultFilePath.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'resultFilePath' is not XSDataString but %s" % self._resultFilePath.__class__.__name__
            raise BaseException(strMessage)
        if comments is None:
            self._comments = None
        elif comments.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'comments' is not XSDataString but %s" % self._comments.__class__.__name__
            raise BaseException(strMessage)
        if crystalSizeX is None:
            self._crystalSizeX = None
        elif crystalSizeX.__class__.__name__ == "XSDataString":
            self._crystalSizeX = crystalSizeX
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'crystalSizeX' is not XSDataString but %s" % self._crystalSizeX.__class__.__name__
            raise BaseException(strMessage)
        if crystalSizeY is None:
            self._crystalSizeY = None
        elif crystalSizeY.__class__.__name__ == "XSDataString":
            self._crystalSizeY = crystalSizeY
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'crystalSizeY' is not XSDataString but %s" % self._crystalSizeY.__class__.__name__
            raise BaseException(strMessage)
        if crystalSizeZ is None:
            self._crystalSizeZ = None
        elif crystalSizeZ.__class__.__name__ == "XSDataString":
            self._crystalSizeZ = crystalSizeZ
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'crystalSizeZ' is not XSDataString but %s" % self._crystalSizeZ.__class__.__name__
            raise BaseException(strMessage)
        if maxDozorScore is None:
            self._maxDozorScore = None
        elif maxDozorScore.__class__.__name__ == "XSDataString":
            self._maxDozorScore = maxDozorScore
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'maxDozorScore' is not XSDataString but %s" % self._maxDozorScore.__class__.__name__
            raise BaseException(strMessage)
        if recordTimeStamp is None:
            self._recordTimeStamp = None
        elif recordTimeStamp.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep constructor argument 'recordTimeStamp' is not XSDataString but %s" % self._recordTimeStamp.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowId' attribute
    def getWorkflowId(self): return self._workflowId
    def setWorkflowId(self, workflowId):
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setWorkflowId argument is not XSDataInteger but %s" % workflowId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowId(self): self._workflowId = None
    workflowId = property(getWorkflowId, setWorkflowId, delWorkflowId, "Property for workflowId")
    # Methods and properties for the 'workflowStepType' attribute
    def getWorkflowStepType(self): return self._workflowStepType
    def setWorkflowStepType(self, workflowStepType):
        if workflowStepType is None:
            self._workflowStepType = None
        elif workflowStepType.__class__.__name__ == "XSDataString":
            self._workflowStepType = workflowStepType
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setWorkflowStepType argument is not XSDataString but %s" % workflowStepType.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowStepType(self): self._workflowStepType = None
    workflowStepType = property(getWorkflowStepType, setWorkflowStepType, delWorkflowStepType, "Property for workflowStepType")
    # Methods and properties for the 'status' attribute
    def getStatus(self): return self._status
    def setStatus(self, status):
        if status is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setStatus argument is not XSDataString but %s" % status.__class__.__name__
            raise BaseException(strMessage)
    def delStatus(self): self._status = None
    status = property(getStatus, setStatus, delStatus, "Property for status")
    # Methods and properties for the 'folderPath' attribute
    def getFolderPath(self): return self._folderPath
    def setFolderPath(self, folderPath):
        if folderPath is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setFolderPath argument is not XSDataString but %s" % folderPath.__class__.__name__
            raise BaseException(strMessage)
    def delFolderPath(self): self._folderPath = None
    folderPath = property(getFolderPath, setFolderPath, delFolderPath, "Property for folderPath")
    # Methods and properties for the 'imageResultFilePath' attribute
    def getImageResultFilePath(self): return self._imageResultFilePath
    def setImageResultFilePath(self, imageResultFilePath):
        if imageResultFilePath is None:
            self._imageResultFilePath = None
        elif imageResultFilePath.__class__.__name__ == "XSDataString":
            self._imageResultFilePath = imageResultFilePath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setImageResultFilePath argument is not XSDataString but %s" % imageResultFilePath.__class__.__name__
            raise BaseException(strMessage)
    def delImageResultFilePath(self): self._imageResultFilePath = None
    imageResultFilePath = property(getImageResultFilePath, setImageResultFilePath, delImageResultFilePath, "Property for imageResultFilePath")
    # Methods and properties for the 'htmlResultFilePath' attribute
    def getHtmlResultFilePath(self): return self._htmlResultFilePath
    def setHtmlResultFilePath(self, htmlResultFilePath):
        if htmlResultFilePath is None:
            self._htmlResultFilePath = None
        elif htmlResultFilePath.__class__.__name__ == "XSDataString":
            self._htmlResultFilePath = htmlResultFilePath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setHtmlResultFilePath argument is not XSDataString but %s" % htmlResultFilePath.__class__.__name__
            raise BaseException(strMessage)
    def delHtmlResultFilePath(self): self._htmlResultFilePath = None
    htmlResultFilePath = property(getHtmlResultFilePath, setHtmlResultFilePath, delHtmlResultFilePath, "Property for htmlResultFilePath")
    # Methods and properties for the 'resultFilePath' attribute
    def getResultFilePath(self): return self._resultFilePath
    def setResultFilePath(self, resultFilePath):
        if resultFilePath is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setResultFilePath argument is not XSDataString but %s" % resultFilePath.__class__.__name__
            raise BaseException(strMessage)
    def delResultFilePath(self): self._resultFilePath = None
    resultFilePath = property(getResultFilePath, setResultFilePath, delResultFilePath, "Property for resultFilePath")
    # Methods and properties for the 'comments' attribute
    ...
    def setComments(self, comments):
        if comments is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setComments argument is not XSDataString but %s" % comments.__class__.__name__
            raise BaseException(strMessage)
    def delComments(self): self._comments = None
    comments = property(getComments, setComments, delComments, "Property for comments")
    # Methods and properties for the 'crystalSizeX' attribute
    def getCrystalSizeX(self): return self._crystalSizeX
    def setCrystalSizeX(self, crystalSizeX):
        if crystalSizeX is None:
            self._crystalSizeX = None
        elif crystalSizeX.__class__.__name__ == "XSDataString":
            self._crystalSizeX = crystalSizeX
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setCrystalSizeX argument is not XSDataString but %s" % crystalSizeX.__class__.__name__
            raise BaseException(strMessage)
    def delCrystalSizeX(self): self._crystalSizeX = None
    crystalSizeX = property(getCrystalSizeX, setCrystalSizeX, delCrystalSizeX, "Property for crystalSizeX")
    # Methods and properties for the 'crystalSizeY' attribute
    def getCrystalSizeY(self): return self._crystalSizeY
    def setCrystalSizeY(self, crystalSizeY):
        if crystalSizeY is None:
            self._crystalSizeY = None
        elif crystalSizeY.__class__.__name__ == "XSDataString":
            self._crystalSizeY = crystalSizeY
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setCrystalSizeY argument is not XSDataString but %s" % crystalSizeY.__class__.__name__
            raise BaseException(strMessage)
    def delCrystalSizeY(self): self._crystalSizeY = None
    crystalSizeY = property(getCrystalSizeY, setCrystalSizeY, delCrystalSizeY, "Property for crystalSizeY")
    # Methods and properties for the 'crystalSizeZ' attribute
    def getCrystalSizeZ(self): return self._crystalSizeZ
    def setCrystalSizeZ(self, crystalSizeZ):
        if crystalSizeZ is None:
            self._crystalSizeZ = None
        elif crystalSizeZ.__class__.__name__ == "XSDataString":
            self._crystalSizeZ = crystalSizeZ
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setCrystalSizeZ argument is not XSDataString but %s" % crystalSizeZ.__class__.__name__
            raise BaseException(strMessage)
    def delCrystalSizeZ(self): self._crystalSizeZ = None
    crystalSizeZ = property(getCrystalSizeZ, setCrystalSizeZ, delCrystalSizeZ, "Property for crystalSizeZ")
    # Methods and properties for the 'maxDozorScore' attribute
    def getMaxDozorScore(self): return self._maxDozorScore
    def setMaxDozorScore(self, maxDozorScore):
        if maxDozorScore is None:
            self._maxDozorScore = None
        elif maxDozorScore.__class__.__name__ == "XSDataString":
            self._maxDozorScore = maxDozorScore
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setMaxDozorScore argument is not XSDataString but %s" % maxDozorScore.__class__.__name__
            raise BaseException(strMessage)
    def delMaxDozorScore(self): self._maxDozorScore = None
    maxDozorScore = property(getMaxDozorScore, setMaxDozorScore, delMaxDozorScore, "Property for maxDozorScore")
    # Methods and properties for the 'recordTimeStamp' attribute
    def getRecordTimeStamp(self): return self._recordTimeStamp
    def setRecordTimeStamp(self, recordTimeStamp):
        if recordTimeStamp is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowStep.setRecordTimeStamp argument is not XSDataString but %s" % recordTimeStamp.__class__.__name__
            raise BaseException(strMessage)
    def delRecordTimeStamp(self): self._recordTimeStamp = None
    recordTimeStamp = property(getRecordTimeStamp, setRecordTimeStamp, delRecordTimeStamp, "Property for recordTimeStamp")
    def export(self, outfile, level, name_='XSDataInputISPyBStoreWorkflowStep'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBStoreWorkflowStep'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._workflowId is not None:
            self.workflowId.export(outfile, level, name_='workflowId')
        else:
            warnEmptyAttribute("workflowId", "XSDataInteger")
        if self._workflowStepType is not None:
            self.workflowStepType.export(outfile, level, name_='workflowStepType')
        else:
            warnEmptyAttribute("workflowStepType", "XSDataString")
        if self._status is not None:
            self.status.export(outfile, level, name_='status')
        else:
            warnEmptyAttribute("status", "XSDataString")
        if self._folderPath is not None:
            self.folderPath.export(outfile, level, name_='folderPath')
        if self._imageResultFilePath is not None:
            self.imageResultFilePath.export(outfile, level, name_='imageResultFilePath')
        if self._htmlResultFilePath is not None:
            self.htmlResultFilePath.export(outfile, level, name_='htmlResultFilePath')
        if self._resultFilePath is not None:
            self.resultFilePath.export(outfile, level, name_='resultFilePath')
        if self._comments is not None:
            self.comments.export(outfile, level, name_='comments')
        if self._crystalSizeX is not None:
            self.crystalSizeX.export(outfile, level, name_='crystalSizeX')
        if self._crystalSizeY is not None:
            self.crystalSizeY.export(outfile, level, name_='crystalSizeY')
        if self._crystalSizeZ is not None:
            self.crystalSizeZ.export(outfile, level, name_='crystalSizeZ')
        if self._maxDozorScore is not None:
            self.maxDozorScore.export(outfile, level, name_='maxDozorScore')
        if self._recordTimeStamp is not None:
            self.recordTimeStamp.export(outfile, level, name_='recordTimeStamp')
    def build(self, node_):
        for child_ in node_.childNodes:
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'workflowStepType':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setWorkflowStepType(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'status':
            obj_ = XSDataString()
            obj_.build(child_)
            ...
            nodeName_ == 'folderPath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setFolderPath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'imageResultFilePath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setImageResultFilePath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'htmlResultFilePath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setHtmlResultFilePath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resultFilePath':
            obj_ = XSDataString()
            obj_.build(child_)
            ...
            nodeName_ == 'crystalSizeX':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setCrystalSizeX(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'crystalSizeY':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setCrystalSizeY(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'crystalSizeZ':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setCrystalSizeZ(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'maxDozorScore':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setMaxDozorScore(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'recordTimeStamp':
            obj_ = XSDataString()
            obj_.build(child_)
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBStoreWorkflowStep" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBStoreWorkflowStep' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBStoreWorkflowStep is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBStoreWorkflowStep.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBStoreWorkflowStep()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBStoreWorkflowStep" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBStoreWorkflowStep


class XSDataInputISPyBUpdateDataCollectionGroupComment(XSDataInput):
    def __init__(self, configuration=None, newComment=None, dataCollectionId=None):
        XSDataInput.__init__(self, configuration)
        if dataCollectionId is None:
            self._dataCollectionId = None
        elif dataCollectionId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataInputISPyBUpdateDataCollectionGroupComment constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
        if newComment is None:
            self._newComment = None
        elif newComment.__class__.__name__ == "XSDataString":
            self._newComment = newComment
        else:
            strMessage = "ERROR! XSDataInputISPyBUpdateDataCollectionGroupComment constructor argument 'newComment' is not XSDataString but %s" % self._newComment.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBUpdateDataCollectionGroupComment.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    # Methods and properties for the 'newComment' attribute
    def getNewComment(self): return self._newComment
    def setNewComment(self, newComment):
        if newComment is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBUpdateDataCollectionGroupComment.setNewComment argument is not XSDataString but %s" % newComment.__class__.__name__
            raise BaseException(strMessage)
    def delNewComment(self): self._newComment = None
    newComment = property(getNewComment, setNewComment, delNewComment, "Property for newComment")
    def export(self, outfile, level, name_='XSDataInputISPyBUpdateDataCollectionGroupComment'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBUpdateDataCollectionGroupComment'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._dataCollectionId is not None:
            self.dataCollectionId.export(outfile, level, name_='dataCollectionId')
        else:
            warnEmptyAttribute("dataCollectionId", "XSDataInteger")
        if self._newComment is not None:
            self.newComment.export(outfile, level, name_='newComment')
        else:
            warnEmptyAttribute("newComment", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'newComment':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setNewComment(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBUpdateDataCollectionGroupComment" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBUpdateDataCollectionGroupComment' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBUpdateDataCollectionGroupComment is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBUpdateDataCollectionGroupComment.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBUpdateDataCollectionGroupComment()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBUpdateDataCollectionGroupComment" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBUpdateDataCollectionGroupComment
...
class XSDataInputRetrieveDataCollection(XSDataInput):
    def __init__(self, configuration=None, dataCollectionId=None, image=None):
        XSDataInput.__init__(self, configuration)
        if image is None:
            self._image = None
        elif image.__class__.__name__ == "XSDataImage":
        ...
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataInputRetrieveDataCollection constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'image' attribute
    def getImage(self): return self._image
    def setImage(self, image):
    ...
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataInputRetrieveDataCollection.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
...
class XSDataInputStoreAutoProcProgramAttachment(XSDataInput):
    def __init__(self, configuration=None, AutoProcProgramAttachment=None):
        XSDataInput.__init__(self, configuration)
        if AutoProcProgramAttachment is None:
            self._AutoProcProgramAttachment = []
        elif AutoProcProgramAttachment.__class__.__name__ == "list":
            ...
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment constructor argument 'AutoProcProgramAttachment' is not list but %s" % self._AutoProcProgramAttachment.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'AutoProcProgramAttachment' attribute
    def getAutoProcProgramAttachment(self): return self._AutoProcProgramAttachment
    def setAutoProcProgramAttachment(self, AutoProcProgramAttachment):
        if AutoProcProgramAttachment is None:
            ...
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment.setAutoProcProgramAttachment argument is not list but %s" % AutoProcProgramAttachment.__class__.__name__
            raise BaseException(strMessage)
    def delAutoProcProgramAttachment(self): self._AutoProcProgramAttachment = None
    AutoProcProgramAttachment = property(getAutoProcProgramAttachment, setAutoProcProgramAttachment, delAutoProcProgramAttachment, "Property for AutoProcProgramAttachment")
    def addAutoProcProgramAttachment(self, value):
        if value is None:
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment.addAutoProcProgramAttachment argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "AutoProcProgramAttachment":
            self._AutoProcProgramAttachment.append(value)
        else:
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment.addAutoProcProgramAttachment argument is not AutoProcProgramAttachment but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertAutoProcProgramAttachment(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment.insertAutoProcProgramAttachment argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment.insertAutoProcProgramAttachment argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "AutoProcProgramAttachment":
            self._AutoProcProgramAttachment[index] = value
        else:
            strMessage = "ERROR! XSDataInputStoreAutoProcProgramAttachment.addAutoProcProgramAttachment argument is not AutoProcProgramAttachment but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataInputStoreAutoProcProgramAttachment'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputStoreAutoProcProgramAttachment'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        for AutoProcProgramAttachment_ in self.getAutoProcProgramAttachment():
            AutoProcProgramAttachment_.export(outfile, level, name_='AutoProcProgramAttachment')
        if self.getAutoProcProgramAttachment() == []:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputStoreAutoProcProgramAttachment" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputStoreAutoProcProgramAttachment' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputStoreAutoProcProgramAttachment is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputStoreAutoProcProgramAttachment.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputStoreAutoProcProgramAttachment()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputStoreAutoProcProgramAttachment" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputStoreAutoProcProgramAttachment


class XSDataInputStoreAutoProcStatus(XSDataInput):
    def __init__(self, configuration=None, anomalous=None, AutoProcStatus=None, AutoProcProgram=None, autoProcStatusId=None, autoProcIntegrationId=None, dataCollectionId=None):
        XSDataInput.__init__(self, configuration)
        if dataCollectionId is None:
            self._dataCollectionId = None
        else:
...
class XSDataInputUpdateSnapshots(XSDataInput):
    def __init__(self, configuration=None, xtalSnapshotFullPath4=None, xtalSnapshotFullPath3=None, xtalSnapshotFullPath2=None, xtalSnapshotFullPath1=None, image=None):
        XSDataInput.__init__(self, configuration)
        if image is None:
            self._image = None
        elif image.__class__.__name__ == "XSDataImage":
            ...
            strMessage = "ERROR! XSDataInputUpdateSnapshots constructor argument 'image' is not XSDataImage but %s" % self._image.__class__.__name__
            raise BaseException(strMessage)
        if xtalSnapshotFullPath1 is None:
            self._xtalSnapshotFullPath1 = None
        elif xtalSnapshotFullPath1.__class__.__name__ == "XSDataFile":
            self._xtalSnapshotFullPath1 = xtalSnapshotFullPath1
        else:
            strMessage = "ERROR! XSDataInputUpdateSnapshots constructor argument 'xtalSnapshotFullPath1' is not XSDataFile but %s" % self._xtalSnapshotFullPath1.__class__.__name__
            raise BaseException(strMessage)
        if xtalSnapshotFullPath2 is None:
            self._xtalSnapshotFullPath2 = None
        elif xtalSnapshotFullPath2.__class__.__name__ == "XSDataFile":
            self._xtalSnapshotFullPath2 = xtalSnapshotFullPath2
        else:
            strMessage = "ERROR! XSDataInputUpdateSnapshots constructor argument 'xtalSnapshotFullPath2' is not XSDataFile but %s" % self._xtalSnapshotFullPath2.__class__.__name__
            raise BaseException(strMessage)
        if xtalSnapshotFullPath3 is None:
            self._xtalSnapshotFullPath3 = None
        elif xtalSnapshotFullPath3.__class__.__name__ == "XSDataFile":
            self._xtalSnapshotFullPath3 = xtalSnapshotFullPath3
        else:
            strMessage = "ERROR! XSDataInputUpdateSnapshots constructor argument 'xtalSnapshotFullPath3' is not XSDataFile but %s" % self._xtalSnapshotFullPath3.__class__.__name__
            raise BaseException(strMessage)
        if xtalSnapshotFullPath4 is None:
            self._xtalSnapshotFullPath4 = None
        elif xtalSnapshotFullPath4.__class__.__name__ == "XSDataFile":
            self._xtalSnapshotFullPath4 = xtalSnapshotFullPath4
        else:
            strMessage = "ERROR! XSDataInputUpdateSnapshots constructor argument 'xtalSnapshotFullPath4' is not XSDataFile but %s" % self._xtalSnapshotFullPath4.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'image' attribute
    def getImage(self): return self._image
    def setImage(self, image):
        if image is None:
            ...
            strMessage = "ERROR! XSDataInputUpdateSnapshots.setImage argument is not XSDataImage but %s" % image.__class__.__name__
            raise BaseException(strMessage)
    def delImage(self): self._image = None
    image = property(getImage, setImage, delImage, "Property for image")
    # Methods and properties for the 'xtalSnapshotFullPath1' attribute
    ...
    def setXtalSnapshotFullPath1(self, xtalSnapshotFullPath1):
        if xtalSnapshotFullPath1 is None:
            ...
            strMessage = "ERROR! XSDataInputUpdateSnapshots.setXtalSnapshotFullPath1 argument is not XSDataFile but %s" % xtalSnapshotFullPath1.__class__.__name__
            raise BaseException(strMessage)
    def delXtalSnapshotFullPath1(self): self._xtalSnapshotFullPath1 = None
    xtalSnapshotFullPath1 = property(getXtalSnapshotFullPath1, setXtalSnapshotFullPath1, delXtalSnapshotFullPath1, "Property for xtalSnapshotFullPath1")
    # Methods and properties for the 'xtalSnapshotFullPath2' attribute
    ...
    def setXtalSnapshotFullPath2(self, xtalSnapshotFullPath2):
        if xtalSnapshotFullPath2 is None:
            ...
            strMessage = "ERROR! XSDataInputUpdateSnapshots.setXtalSnapshotFullPath2 argument is not XSDataFile but %s" % xtalSnapshotFullPath2.__class__.__name__
            raise BaseException(strMessage)
    def delXtalSnapshotFullPath2(self): self._xtalSnapshotFullPath2 = None
    xtalSnapshotFullPath2 = property(getXtalSnapshotFullPath2, setXtalSnapshotFullPath2, delXtalSnapshotFullPath2, "Property for xtalSnapshotFullPath2")
    # Methods and properties for the 'xtalSnapshotFullPath3' attribute
    ...
    def setXtalSnapshotFullPath3(self, xtalSnapshotFullPath3):
        if xtalSnapshotFullPath3 is None:
            ...
            strMessage = "ERROR! XSDataInputUpdateSnapshots.setXtalSnapshotFullPath3 argument is not XSDataFile but %s" % xtalSnapshotFullPath3.__class__.__name__
            raise BaseException(strMessage)
    def delXtalSnapshotFullPath3(self): self._xtalSnapshotFullPath3 = None
    xtalSnapshotFullPath3 = property(getXtalSnapshotFullPath3, setXtalSnapshotFullPath3, delXtalSnapshotFullPath3, "Property for xtalSnapshotFullPath3")
    # Methods and properties for the 'xtalSnapshotFullPath4' attribute
    ...
    def setXtalSnapshotFullPath4(self, xtalSnapshotFullPath4):
        if xtalSnapshotFullPath4 is None:
            ...
            strMessage = "ERROR! XSDataInputUpdateSnapshots.setXtalSnapshotFullPath4 argument is not XSDataFile but %s" % xtalSnapshotFullPath4.__class__.__name__
            raise BaseException(strMessage)
    def delXtalSnapshotFullPath4(self): self._xtalSnapshotFullPath4 = None
    xtalSnapshotFullPath4 = property(getXtalSnapshotFullPath4, setXtalSnapshotFullPath4, delXtalSnapshotFullPath4, "Property for xtalSnapshotFullPath4")
    def export(self, outfile, level, name_='XSDataInputUpdateSnapshots'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputUpdateSnapshots'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._image is not None:
            self.image.export(outfile, level, name_='image')
        else:
            warnEmptyAttribute("image", "XSDataImage")
        if self._xtalSnapshotFullPath1 is not None:
            self.xtalSnapshotFullPath1.export(outfile, level, name_='xtalSnapshotFullPath1')
        else:
            warnEmptyAttribute("xtalSnapshotFullPath1", "XSDataFile")
        if self._xtalSnapshotFullPath2 is not None:
            self.xtalSnapshotFullPath2.export(outfile, level, name_='xtalSnapshotFullPath2')
        if self._xtalSnapshotFullPath3 is not None:
            self.xtalSnapshotFullPath3.export(outfile, level, name_='xtalSnapshotFullPath3')
        if self._xtalSnapshotFullPath4 is not None:
            self.xtalSnapshotFullPath4.export(outfile, level, name_='xtalSnapshotFullPath4')
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setXtalSnapshotFullPath1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'xtalSnapshotFullPath2':
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setXtalSnapshotFullPath2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'xtalSnapshotFullPath3':
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setXtalSnapshotFullPath3(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'xtalSnapshotFullPath4':
            obj_ = XSDataFile()
            obj_.build(child_)
            self.setXtalSnapshotFullPath4(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputUpdateSnapshots" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputUpdateSnapshots' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputUpdateSnapshots is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputUpdateSnapshots.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputUpdateSnapshots()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputUpdateSnapshots" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputUpdateSnapshots
...
class XSDataResultISPyBGetPdbFilePath(XSDataResult):
    def __init__(self, status=None, pdbFilePath=None):
        XSDataResult.__init__(self, status)
        if pdbFilePath is None:
            self._pdbFilePath = None
        elif pdbFilePath.__class__.__name__ == "XSDataString":
            self._pdbFilePath = pdbFilePath
        else:
            strMessage = "ERROR! XSDataResultISPyBGetPdbFilePath constructor argument 'pdbFilePath' is not XSDataString but %s" % self._pdbFilePath.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'pdbFilePath' attribute
    def getPdbFilePath(self): return self._pdbFilePath
    def setPdbFilePath(self, pdbFilePath):
        if pdbFilePath is None:
            self._pdbFilePath = None
        elif pdbFilePath.__class__.__name__ == "XSDataString":
            self._pdbFilePath = pdbFilePath
        else:
            strMessage = "ERROR! XSDataResultISPyBGetPdbFilePath.setPdbFilePath argument is not XSDataString but %s" % pdbFilePath.__class__.__name__
            raise BaseException(strMessage)
    def delPdbFilePath(self): self._pdbFilePath = None
    pdbFilePath = property(getPdbFilePath, setPdbFilePath, delPdbFilePath, "Property for pdbFilePath")
    def export(self, outfile, level, name_='XSDataResultISPyBGetPdbFilePath'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBGetPdbFilePath'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._pdbFilePath is not None:
            self.pdbFilePath.export(outfile, level, name_='pdbFilePath')
        else:
            warnEmptyAttribute("pdbFilePath", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'pdbFilePath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setPdbFilePath(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBGetPdbFilePath" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBGetPdbFilePath' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBGetPdbFilePath is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBGetPdbFilePath.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBGetPdbFilePath()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBGetPdbFilePath" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBGetPdbFilePath
...
class XSDataResultISPyBStoreWorkflowStep(XSDataResult):
    def __init__(self, status=None, workflowStepId=None):
        XSDataResult.__init__(self, status)
        if workflowStepId is None:
            self._workflowStepId = None
        elif workflowStepId.__class__.__name__ == "XSDataInteger":
            self._workflowStepId = workflowStepId
        else:
            strMessage = "ERROR! XSDataResultISPyBStoreWorkflowStep constructor argument 'workflowStepId' is not XSDataInteger but %s" % self._workflowStepId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowStepId' attribute
    def getWorkflowStepId(self): return self._workflowStepId
    def setWorkflowStepId(self, workflowStepId):
        if workflowStepId is None:
            self._workflowStepId = None
        elif workflowStepId.__class__.__name__ == "XSDataInteger":
            self._workflowStepId = workflowStepId
        else:
            strMessage = "ERROR! XSDataResultISPyBStoreWorkflowStep.setWorkflowStepId argument is not XSDataInteger but %s" % workflowStepId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowStepId(self): self._workflowStepId = None
    workflowStepId = property(getWorkflowStepId, setWorkflowStepId, delWorkflowStepId, "Property for workflowStepId")
    def export(self, outfile, level, name_='XSDataResultISPyBStoreWorkflowStep'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBStoreWorkflowStep'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._workflowStepId is not None:
            self.workflowStepId.export(outfile, level, name_='workflowStepId')
        else:
            warnEmptyAttribute("workflowStepId", "XSDataInteger")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'workflowStepId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setWorkflowStepId(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBStoreWorkflowStep" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBStoreWorkflowStep' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBStoreWorkflowStep is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBStoreWorkflowStep.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBStoreWorkflowStep()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBStoreWorkflowStep" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBStoreWorkflowStep


class XSDataResultISPyBUpdateDataCollectionGroupComment(XSDataResult):
    def __init__(self, status=None, dataCollectionGroupId=None):
        ...
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBUpdateDataCollectionGroupComment constructor argument 'dataCollectionGroupId' is not XSDataInteger but %s" % self._dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionGroupId' attribute
    def getDataCollectionGroupId(self): return self._dataCollectionGroupId
    def setDataCollectionGroupId(self, dataCollectionGroupId):
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBUpdateDataCollectionGroupComment.setDataCollectionGroupId argument is not XSDataInteger but %s" % dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionGroupId(self): self._dataCollectionGroupId = None
    dataCollectionGroupId = property(getDataCollectionGroupId, setDataCollectionGroupId, delDataCollectionGroupId, "Property for dataCollectionGroupId")
    def export(self, outfile, level, name_='XSDataResultISPyBUpdateDataCollectionGroupComment'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBUpdateDataCollectionGroupComment'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._dataCollectionGroupId is not None:
            self.dataCollectionGroupId.export(outfile, level, name_='dataCollectionGroupId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBUpdateDataCollectionGroupComment" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBUpdateDataCollectionGroupComment' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBUpdateDataCollectionGroupComment is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBUpdateDataCollectionGroupComment.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBUpdateDataCollectionGroupComment()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBUpdateDataCollectionGroupComment" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBUpdateDataCollectionGroupComment
...
class XSDataResultStoreAutoProc(XSDataResult):
    def __init__(self, status=None, autoProcProgramId=None, autoProcScalingId=None, autoProcIntegrationId=None, autoProcId=None):
        XSDataResult.__init__(self, status)
        if autoProcId is None:
            self._autoProcId = None
        ...
        if autoProcIntegrationId is None:
            self._autoProcIntegrationId = None
        elif autoProcIntegrationId.__class__.__name__ == "XSDataInteger":
            self._autoProcIntegrationId = autoProcIntegrationId
        else:
            strMessage = "ERROR! XSDataResultStoreAutoProc constructor argument 'autoProcIntegrationId' is not XSDataInteger but %s" % self._autoProcIntegrationId.__class__.__name__
            raise BaseException(strMessage)
        if autoProcScalingId is None:
            self._autoProcScalingId = None
        ...
        if autoProcProgramId is None:
            ...
            strMessage = "ERROR! XSDataResultStoreAutoProc constructor argument 'autoProcProgramId' is not XSDataInteger but %s" % self._autoProcProgramId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'autoProcId' attribute
    def getAutoProcId(self): return self._autoProcId
    def setAutoProcId(self, autoProcId):
    ...
    def setAutoProcIntegrationId(self, autoProcIntegrationId):
        if autoProcIntegrationId is None:
            ...
            strMessage = "ERROR! XSDataResultStoreAutoProc.setAutoProcIntegrationId argument is not XSDataInteger but %s" % autoProcIntegrationId.__class__.__name__
            raise BaseException(strMessage)
    def delAutoProcIntegrationId(self): self._autoProcIntegrationId = None
    autoProcIntegrationId = property(getAutoProcIntegrationId, setAutoProcIntegrationId, delAutoProcIntegrationId, "Property for autoProcIntegrationId")
    # Methods and properties for the 'autoProcScalingId' attribute
    ...
    def setAutoProcProgramId(self, autoProcProgramId):
        if autoProcProgramId is None:
            ...
            strMessage = "ERROR! XSDataResultStoreAutoProc.setAutoProcProgramId argument is not XSDataInteger but %s" % autoProcProgramId.__class__.__name__
            raise BaseException(strMessage)
    def delAutoProcProgramId(self): self._autoProcProgramId = None
    autoProcProgramId = property(getAutoProcProgramId, setAutoProcProgramId, delAutoProcProgramId, "Property for autoProcProgramId")
    ...
    def exportChildren(self, outfile, level, name_='XSDataResultStoreAutoProc'):
        ...
        if self._autoProcIntegrationId is not None:
            self.autoProcIntegrationId.export(outfile, level, name_='autoProcIntegrationId')
        if self._autoProcScalingId is not None:
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setAutoProcIntegrationId(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'autoProcScalingId':
            obj_ = XSDataInteger()
            obj_.build(child_)
...
class XSDataResultStoreAutoProcProgramAttachment(XSDataResult):
    def __init__(self, status=None, autoProcProgramAttachmentId=None):
        XSDataResult.__init__(self, status)
        if autoProcProgramAttachmentId is None:
            self._autoProcProgramAttachmentId = []
        elif autoProcProgramAttachmentId.__class__.__name__ == "list":
            self._autoProcProgramAttachmentId = autoProcProgramAttachmentId
        else:
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment constructor argument 'autoProcProgramAttachmentId' is not list but %s" % self._autoProcProgramAttachmentId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'autoProcProgramAttachmentId' attribute
    def getAutoProcProgramAttachmentId(self): return self._autoProcProgramAttachmentId
    def setAutoProcProgramAttachmentId(self, autoProcProgramAttachmentId):
        if autoProcProgramAttachmentId is None:
            ...
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment.setAutoProcProgramAttachmentId argument is not list but %s" % autoProcProgramAttachmentId.__class__.__name__
            raise BaseException(strMessage)
    def delAutoProcProgramAttachmentId(self): self._autoProcProgramAttachmentId = None
    autoProcProgramAttachmentId = property(getAutoProcProgramAttachmentId, setAutoProcProgramAttachmentId, delAutoProcProgramAttachmentId, "Property for autoProcProgramAttachmentId")
    def addAutoProcProgramAttachmentId(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment.addAutoProcProgramAttachmentId argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._autoProcProgramAttachmentId.append(value)
        else:
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment.addAutoProcProgramAttachmentId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertAutoProcProgramAttachmentId(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment.insertAutoProcProgramAttachmentId argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment.insertAutoProcProgramAttachmentId argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._autoProcProgramAttachmentId[index] = value
        else:
            strMessage = "ERROR! XSDataResultStoreAutoProcProgramAttachment.addAutoProcProgramAttachmentId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataResultStoreAutoProcProgramAttachment'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultStoreAutoProcProgramAttachment'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        for autoProcProgramAttachmentId_ in self.getAutoProcProgramAttachmentId():
            autoProcProgramAttachmentId_.export(outfile, level, name_='autoProcProgramAttachmentId')
        if self.getAutoProcProgramAttachmentId() == []:
            warnEmptyAttribute("autoProcProgramAttachmentId", "XSDataInteger")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.autoProcProgramAttachmentId.append(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultStoreAutoProcProgramAttachment" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultStoreAutoProcProgramAttachment' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultStoreAutoProcProgramAttachment is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultStoreAutoProcProgramAttachment.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultStoreAutoProcProgramAttachment()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultStoreAutoProcProgramAttachment" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultStoreAutoProcProgramAttachment


class XSDataResultStoreAutoProcStatus(XSDataResult):
    def __init__(self, status=None, autoProcStatusId=None, autoProcProgramId=None, autoProcIntegrationId=None):
        XSDataResult.__init__(self, status)
        if autoProcIntegrationId is None:
            self._autoProcIntegrationId = None
        else:
    ...
    def exportChildren(self, outfile, level, name_='XSDataResultStoreAutoProcStatus'):
        ...
        if self._autoProcProgramId is not None:
            ...
            warnEmptyAttribute("autoProcProgramId", "integer")
        if self._autoProcStatusId is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<autoProcStatusId>%d</autoProcStatusId>\n' % self._autoProcStatusId))
        else:
...
class XSDataResultUpdateSnapshots(XSDataResult):
    def __init__(self, status=None, dataCollectionId=None):
        XSDataResult.__init__(self, status)
        if dataCollectionId is None:
            self._dataCollectionId = None
            ...
            strMessage = "ERROR! XSDataResultUpdateSnapshots constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultUpdateSnapshots.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    def export(self, outfile, level, name_='XSDataResultUpdateSnapshots'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultUpdateSnapshots'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._dataCollectionId is not None:
            self.dataCollectionId.export(outfile, level, name_='dataCollectionId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultUpdateSnapshots" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultUpdateSnapshots' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultUpdateSnapshots is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultUpdateSnapshots.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultUpdateSnapshots()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultUpdateSnapshots" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultUpdateSnapshots
