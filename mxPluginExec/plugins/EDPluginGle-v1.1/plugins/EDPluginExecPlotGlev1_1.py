...
import os, tempfile, numpy, threading, shlex, shutil, subprocess, json
...
from XSDataPlotGlev1_1 import XSDataGraph
from XSDataPlotGlev1_1 import XSDataPlot
from XSDataPlotGlev1_1 import XSDataPlotSet
from XSDataPlotGlev1_1 import XSDataInputPlotGle
from XSDataPlotGlev1_1 import XSDataResultPlotGle

class EDPluginExecPlotGlev1_1(EDPluginExec):
    """
        ...
        for iIndex in range(len(strLines)):
            ...
            if strLine.find("$ DATA=") != -1:
                ...
                if xsDataGraph is not None:
                    xsDataGraph.data = json.dumps(listData)
