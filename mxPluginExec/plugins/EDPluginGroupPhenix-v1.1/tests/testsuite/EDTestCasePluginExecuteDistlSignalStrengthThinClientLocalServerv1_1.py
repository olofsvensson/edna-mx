...
class EDTestCasePluginExecuteDistlSignalStrengthThinClientLocalServerv1_1(EDTestCasePluginExecuteDistlSignalStrengthThinClientv1_1):
    ...
    def preProcess(self):
        ...
        strServerPort = edPlugin.config.get(EDPluginDistlSignalStrengthThinClientv1_1.CONF_DISTL_SIGNAL_STRENGTH_SERVER_PORT, None)
        ...
        strPathToServer = edPlugin.config.get(EDPluginDistlSignalStrengthThinClientv1_1.CONF_PATH_TO_DISTL_SIGNAL_STRENGTH_SERVER, None)
