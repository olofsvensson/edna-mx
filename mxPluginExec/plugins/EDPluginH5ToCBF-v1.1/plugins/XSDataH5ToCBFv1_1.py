...
#
# Generated Tue Apr 26 08:34::02 2016 by EDGenerateDS.
#
...
class XSDataInputH5ToCBF(XSDataInput):
    ...
    def setDataCollection(self, dataCollection):
        if dataCollection is None:
            ...
            strMessage = "ERROR! XSDataInputH5ToCBF.setDataCollection argument is not XSDataISPyBDataCollection but %s" % dataCollection.__class__.__name__
            raise BaseException(strMessage)
