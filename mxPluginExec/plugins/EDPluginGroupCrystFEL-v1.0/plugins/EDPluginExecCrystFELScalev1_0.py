...
class EDPluginExecCrystFELScalev1_0(EDPluginExecProcessScript):
    """
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginExecCrystFELScalev1_0.checkParameters")
        self.checkMandatoryParameters(self.dataInput, "Data Input is None")


    def configure(self):
        EDPluginExecProcessScript.configure(self)
        self.DEBUG("EDPluginExecCrystFELScalev1_0.configure")

    def preProcess(self, _edObject=None):
        EDPluginExecProcessScript.preProcess(self)
        self.DEBUG("EDPluginExecCrystFELScalev1_0.preProcess")
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginExecCrystFELScalev1_0.postProcess")
    ...
    def generateCommandLine(self, _xsDataInputCrystFEL):
        ...
        """
        self.DEBUG("EDPluginExecCrystFELScalev1_0.generateCommands")
        outFile = "lyso_4_tp01_CrystFEL.stream"

        strCommandText = "-i %s -o %s -y 222 --iterations=1 --model=unity --max-adu=7000" % \
