...
class EDTestCaseEDFactoryPlugin(EDTestCase):
    ...
    def testGetProjectRootDirectory(self):
        ...
        strTestProjectRootDirectory1 = str(edFactoryPlugin.getProjectRootDirectory("EDPluginTestPluginFactory"))
        EDAssert.equal(strTestProjectRootDirectoryReference, strTestProjectRootDirectory1)
        strTestProjectRootDirectory2 = str(edFactoryPlugin.getProjectRootDirectory("XSDataTestProject"))
